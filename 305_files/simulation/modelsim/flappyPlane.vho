...
SIGNAL \inst8|char_address[0]~2_combout\ : std_logic;
SIGNAL \inst8|char_address[1]~3_combout\ : std_logic;
SIGNAL \inst8|char_address[2]~4_combout\ : std_logic;
SIGNAL \inst8|char_address[5]~5_combout\ : std_logic;
...
SIGNAL \inst8|ALT_INV_LessThan4~0_combout\ : std_logic;
...
\inst9|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\inst8|char_address[5]~5_combout\ & \~GND~combout\ & \~GND~combout\ & \inst8|char_address[2]~4_combout\ & \inst8|char_address[1]~3_combout\ & \inst8|char_address[0]~2_combout\ & 
\inst2|pixel_row\(3) & \inst2|pixel_row\(2) & \inst2|pixel_row\(1));
...
\inst5|ALT_INV_SHIFTOUT\(2) <= NOT \inst5|SHIFTOUT\(2);
...
\inst8|ALT_INV_LessThan4~0_combout\ <= NOT \inst8|LessThan4~0_combout\;
...
-- Equation(s):
-- \inst5|Equal2~0_combout\ = ( !\inst5|filter\(2) & ( (!\inst5|filter\(1) & (!\inst5|filter\(4) & (!\inst5|filter\(3) & !\inst5|filter\(0)))) ) )
...
-- Equation(s):
-- \inst5|Equal1~0_combout\ = ( \inst5|filter\(0) & ( (\inst5|filter\(1) & (\inst5|filter\(4) & (\inst5|filter\(2) & \inst5|filter\(3)))) ) )
...
-- !\inst5|MOUSE_CLK_FILTER~q\ & ( (\inst5|filter\(6) & (\inst5|filter\(7) & \inst5|Equal1~0_combout\)) ) ) )
...
-- Equation(s):
-- \inst5|OUTCNT~1_combout\ = ( \inst5|OUTCNT\(2) & ( \inst5|OUTCNT\(1) & ( (!\inst5|OUTCNT\(3) & !\inst5|OUTCNT\(0)) ) ) ) # ( !\inst5|OUTCNT\(2) & ( \inst5|OUTCNT\(1) & ( (!\inst5|OUTCNT\(3) & \inst5|OUTCNT\(0)) ) ) ) # ( \inst5|OUTCNT\(2) & ( 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101010101010101010101010111011101110101011101110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Location: LABCELL_X14_Y16_N12
\inst5|OUTCNT~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst5|OUTCNT~0_combout\ = ( !\inst5|OUTCNT\(3) & ( \inst5|OUTCNT\(2) & ( (\inst5|OUTCNT\(1) & \inst5|OUTCNT\(0)) ) ) ) # ( \inst5|OUTCNT\(3) & ( !\inst5|OUTCNT\(2) & ( !\inst5|OUTCNT\(1) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101010101010101000000101000001010000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|OUTCNT~2_combout\ = ( !\inst5|OUTCNT\(3) & ( \inst5|OUTCNT\(2) & ( !\inst5|OUTCNT\(0) $ (!\inst5|OUTCNT\(1)) ) ) ) # ( \inst5|OUTCNT\(3) & ( !\inst5|OUTCNT\(2) & ( (\inst5|OUTCNT\(0) & !\inst5|OUTCNT\(1)) ) ) ) # ( !\inst5|OUTCNT\(3) & ( 
-- !\inst5|OUTCNT\(2) & ( !\inst5|OUTCNT\(0) $ (!\inst5|OUTCNT\(1)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010110101010010101010000000001010101101010100000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|INCNT~4_combout\ = ( \inst5|INCNT\(1) & ( (!\inst5|INCNT\(0) & !\inst5|INCNT\(3)) ) ) # ( !\inst5|INCNT\(1) & ( (!\inst5|INCNT\(0) & ((!\inst5|INCNT\(3)) # (!\inst5|INCNT\(2)))) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111100000000111111111111111111111111000000001000000010000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|Selector6~0_combout\ = ( \inst5|mouse_state.LOAD_COMMAND2~DUPLICATE_q\ ) # ( !\inst5|mouse_state.LOAD_COMMAND2~DUPLICATE_q\ & ( ((\inst5|send_data~q\ & ((!\inst5|mouse_state.INHIBIT_TRANS~q\) # (\inst5|mouse_state.INPUT_PACKETS~q\)))) # 
-- (\inst5|mouse_state.LOAD_COMMAND~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010111110111111111111111111101010101111101111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \inst5|ALT_INV_mouse_state.LOAD_COMMAND2~DUPLICATE_q\,
	combout => \inst5|Selector6~0_combout\);

-- Location: FF_X14_Y16_N59
...
-- Equation(s):
-- \inst5|MOUSE_DATA_BUF~0_combout\ = ( \inst5|OUTCNT\(2) & ( \inst5|mouse_state.WAIT_OUTPUT_READY~q\ & ( (!\inst5|OUTCNT\(3) & !\inst5|send_char~q\) ) ) ) # ( !\inst5|OUTCNT\(2) & ( \inst5|mouse_state.WAIT_OUTPUT_READY~q\ & ( (!\inst5|send_char~q\ & 
-- ((!\inst5|OUTCNT\(1)) # (!\inst5|OUTCNT\(3)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011100000111000001100000011000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_OUTCNT\(1),
...
-- Location: MLABCELL_X13_Y16_N21
\inst5|SHIFTOUT[1]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
...
-- pragma translate_on
PORT MAP (
	datac => \inst5|ALT_INV_SHIFTOUT\(2),
	combout => \inst5|SHIFTOUT[1]~feeder_combout\);

-- Location: FF_X13_Y16_N22
...
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_SHIFTOUT\(1),
...
-- Location: MLABCELL_X13_Y16_N15
\inst5|WideOr4\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst5|WideOr4~combout\ = ( \inst5|mouse_state.LOAD_COMMAND2~DUPLICATE_q\ & ( \inst5|mouse_state.LOAD_COMMAND~q\ ) ) # ( !\inst5|mouse_state.LOAD_COMMAND2~DUPLICATE_q\ & ( \inst5|mouse_state.LOAD_COMMAND~q\ ) ) # ( 
-- \inst5|mouse_state.LOAD_COMMAND2~DUPLICATE_q\ & ( !\inst5|mouse_state.LOAD_COMMAND~q\ ) ) # ( !\inst5|mouse_state.LOAD_COMMAND2~DUPLICATE_q\ & ( !\inst5|mouse_state.LOAD_COMMAND~q\ & ( !\inst5|mouse_state.INHIBIT_TRANS~q\ ) ) )
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = ( !\inst2|h_count\(6) & ( \inst2|h_count\(1) & ( (\inst2|h_count\(4) & (\inst2|h_count\(9) & (\inst2|h_count\(0) & \inst2|h_count\(3)))) ) ) )
...
-- Equation(s):
-- \inst2|Equal0~1_combout\ = ( \inst2|Equal0~0_combout\ & ( (\inst2|h_count\(8) & (!\inst2|h_count\(7) & (!\inst2|h_count\(5) & \inst2|h_count[2]~DUPLICATE_q\))) ) )
...
-- Equation(s):
-- \inst2|LessThan1~0_combout\ = ( \inst2|h_count\(1) & ( (!\inst2|h_count\(0) & !\inst2|h_count[2]~DUPLICATE_q\) ) ) # ( !\inst2|h_count\(1) & ( !\inst2|h_count[2]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \inst2|process_0~4_combout\ = ( \inst2|h_count\(3) & ( (!\inst2|h_count\(6) & ((!\inst2|h_count\(4)) # ((!\inst2|h_count\(5)) # (\inst2|LessThan1~0_combout\)))) ) ) # ( !\inst2|h_count\(3) & ( !\inst2|h_count\(6) ) )
...
-- Equation(s):
-- \inst2|Equal1~0_combout\ = ( \inst2|Equal0~0_combout\ & ( (!\inst2|h_count\(8) & (\inst2|h_count\(7) & (!\inst2|h_count[2]~DUPLICATE_q\ & \inst2|h_count\(5)))) ) )
...
-- Equation(s):
-- \inst2|v_count[1]~0_combout\ = ( \inst2|h_count\(7) & ( ((\inst2|process_0~6_combout\ & ((!\inst2|process_0~4_combout\) # (\inst2|h_count\(8))))) # (\inst2|Equal1~0_combout\) ) ) # ( !\inst2|h_count\(7) & ( ((\inst2|h_count\(8) & 
...
-- Equation(s):
-- \inst2|process_0~5_combout\ = ( !\inst2|v_count\(8) & ( (!\inst2|v_count\(6) & (!\inst2|v_count\(5) & (!\inst2|v_count\(4) & !\inst2|v_count[7]~DUPLICATE_q\))) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000110011000000010011001100000001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_v_count\(3),
	datab => \inst2|ALT_INV_h_count[9]~DUPLICATE_q\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001100000011000000110000001100001011000010110000101100001011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_process_0~4_combout\,
...
-- Equation(s):
-- \inst2|process_0~0_combout\ = ( !\inst2|v_count\(4) & ( (!\inst2|v_count\(9) & (!\inst2|v_count\(0) $ (!\inst2|v_count[1]~DUPLICATE_q\))) ) )
...
-- Equation(s):
-- \inst2|LessThan7~0_combout\ = ( \inst2|v_count\(8) & ( (\inst2|v_count\(5) & (\inst2|v_count\(6) & \inst2|v_count[7]~DUPLICATE_q\)) ) )
...
-- Equation(s):
-- \inst2|process_0~2_combout\ = ( \inst2|h_count\(1) & ( (!\inst2|h_count\(4)) # ((!\inst2|h_count\(3) & (!\inst2|h_count\(0) & !\inst2|h_count[2]~DUPLICATE_q\))) ) ) # ( !\inst2|h_count\(1) & ( (!\inst2|h_count\(4)) # ((!\inst2|h_count\(3) & 
-- !\inst2|h_count[2]~DUPLICATE_q\)) ) )
...
-- Equation(s):
-- \inst5|new_cursor_column[9]~0_combout\ = ( \inst5|PACKET_COUNT\(1) & ( !\inst5|PACKET_COUNT\(0) ) ) # ( !\inst5|PACKET_COUNT\(1) & ( \inst5|PACKET_COUNT\(0) ) )
...
-- Equation(s):
-- \inst5|right_button~0_combout\ = ( \inst5|LessThan1~0_combout\ & ( (\inst5|READ_CHAR~q\ & (!\inst5|mouse_state.WAIT_OUTPUT_READY~q\ & !\inst5|Equal4~0_combout\)) ) )
...
-- Equation(s):
-- \inst5|new_cursor_row[9]~0_combout\ = ( !\inst5|mouse_state.WAIT_OUTPUT_READY~q\ & ( (\inst5|READ_CHAR~q\ & (\inst5|LessThan1~0_combout\ & !\inst5|new_cursor_column[9]~0_combout\)) ) )
...
-- Equation(s):
-- \inst5|LessThan5~0_combout\ = ( !\inst5|new_cursor_row\(4) & ( (!\inst5|new_cursor_row\(3) & (!\inst5|new_cursor_row\(0) & (!\inst5|new_cursor_row\(2) & !\inst5|new_cursor_row\(1)))) ) )
...
-- Equation(s):
-- \inst5|cursor_row~7_combout\ = ( \inst5|LessThan5~1_combout\ & ( (!\inst5|new_cursor_row\(9) & (\inst5|new_cursor_row\(4) & ((!\inst5|new_cursor_row\(8)) # (\inst5|LessThan5~0_combout\)))) ) ) # ( !\inst5|LessThan5~1_combout\ & ( 
...
-- Equation(s):
-- \inst5|cursor_row~8_combout\ = ( \inst5|RECV_UART~2_combout\ & ( \inst5|cursor_row\(8) & ( ((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))) # (\inst5|cursor_row~7_combout\) ) ) ) # ( !\inst5|RECV_UART~2_combout\ & ( \inst5|cursor_row\(8) & ( 
-- ((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))) # (\inst5|cursor_row~7_combout\) ) ) ) # ( \inst5|RECV_UART~2_combout\ & ( !\inst5|cursor_row\(8) & ( ((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))) # (\inst5|cursor_row~7_combout\) ) ) ) # 
-- ( !\inst5|RECV_UART~2_combout\ & ( !\inst5|cursor_row\(8) & ( (!\inst5|cursor_row\(7) & (!\inst5|PACKET_COUNT\(1) & ((!\inst5|PACKET_COUNT\(0))))) # (\inst5|cursor_row\(7) & (((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))) # 
-- (\inst5|cursor_row~7_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110100000101110011110000111111001111000011111100111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_row\(7),
...
-- Equation(s):
-- \inst5|RECV_UART~2_combout\ = ( \inst5|RECV_UART~1_combout\ & ( (!\inst5|new_cursor_row\(9) & ((!\inst5|new_cursor_row\(8) & (!\inst5|RECV_UART~0_combout\)) # (\inst5|new_cursor_row\(8) & (\inst5|RECV_UART~0_combout\ & !\inst5|new_cursor_row\(0))))) ) ) # 
...
-- Equation(s):
-- \inst5|cursor_row~1_combout\ = ( \inst5|PACKET_COUNT\(0) & ( \inst5|cursor_row\(8) & ( !\inst5|cursor_row~0_combout\ ) ) ) # ( !\inst5|PACKET_COUNT\(0) & ( \inst5|cursor_row\(8) & ( (\inst5|PACKET_COUNT\(1) & !\inst5|cursor_row~0_combout\) ) ) ) # ( 
-- \inst5|PACKET_COUNT\(0) & ( !\inst5|cursor_row\(8) & ( (!\inst5|cursor_row~0_combout\ & ((\inst5|cursor_row\(7)) # (\inst5|RECV_UART~2_combout\))) ) ) ) # ( !\inst5|PACKET_COUNT\(0) & ( !\inst5|cursor_row\(8) & ( (\inst5|PACKET_COUNT\(1) & 
-- (!\inst5|cursor_row~0_combout\ & ((\inst5|cursor_row\(7)) # (\inst5|RECV_UART~2_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000000110000010100001111000000110000001100001111000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst6|SevenSeg_out~0_combout\ = (!\inst5|cursor_row\(7) & (\inst5|cursor_row\(8))) # (\inst5|cursor_row\(7) & ((!\inst5|cursor_row\(8)) # (!\inst5|cursor_row\(6))))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101111101011010010111110101101001011111010110100101111101011010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_row\(7),
...
-- Equation(s):
-- \inst6|SevenSeg_out[5]~1_combout\ = (!\inst5|cursor_row\(6) & (!\inst5|cursor_row\(8) & \inst5|cursor_row\(7))) # (\inst5|cursor_row\(6) & ((!\inst5|cursor_row\(8)) # (\inst5|cursor_row\(7))))
...
-- Equation(s):
-- \inst6|SevenSeg_out[1]~5_combout\ = (!\inst5|cursor_row\(8)) # (!\inst5|cursor_row\(7) $ (\inst5|cursor_row\(6)))
...
-- Equation(s):
-- \inst5|PACKET_CHAR2[7]~1_combout\ = ( !\inst5|mouse_state.WAIT_OUTPUT_READY~q\ & ( (\inst5|READ_CHAR~q\ & (!\inst5|PACKET_COUNT\(0) & (\inst5|LessThan1~0_combout\ & \inst5|PACKET_COUNT\(1)))) ) )
...
-- Equation(s):
-- \inst5|cursor_column~4_combout\ = ( \inst5|new_cursor_column\(9) & ( (!\inst5|new_cursor_column\(8) & (!\inst5|new_cursor_column\(7) & \inst5|new_cursor_column\(0))) ) ) # ( !\inst5|new_cursor_column\(9) & ( \inst5|new_cursor_column\(0) ) )
...
-- Equation(s):
-- \inst5|cursor_column[5]~1_combout\ = ( \inst5|cursor_column\(8) & ( \inst5|RECV_UART~4_combout\ & ( (!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0)) ) ) ) # ( !\inst5|cursor_column\(8) & ( \inst5|RECV_UART~4_combout\ & ( (!\inst5|PACKET_COUNT\(1) & 
-- !\inst5|PACKET_COUNT\(0)) ) ) ) # ( \inst5|cursor_column\(8) & ( !\inst5|RECV_UART~4_combout\ & ( (!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0)) ) ) ) # ( !\inst5|cursor_column\(8) & ( !\inst5|RECV_UART~4_combout\ & ( (!\inst5|cursor_column\(7) & 
-- ((!\inst5|cursor_column\(9)) # ((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))))) # (\inst5|cursor_column\(7) & (((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))))) ) ) )
...
-- ((!\inst5|new_cursor_column\(9)) # ((!\inst5|new_cursor_column\(0) & \inst5|RECV_UART~3_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011111111111100101111111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|Add5~25_sumout\ = SUM(( \inst5|PACKET_CHAR2\(1) ) + ( \inst5|cursor_column\(1) ) + ( \inst5|Add5~6\ ))
-- \inst5|Add5~26\ = CARRY(( \inst5|PACKET_CHAR2\(1) ) + ( \inst5|cursor_column\(1) ) + ( \inst5|Add5~6\ ))
...
-- Equation(s):
-- \inst5|cursor_column~8_combout\ = ( \inst5|new_cursor_column\(8) & ( \inst5|new_cursor_column\(2) & ( !\inst5|new_cursor_column\(9) ) ) ) # ( !\inst5|new_cursor_column\(8) & ( \inst5|new_cursor_column\(2) & ( (!\inst5|new_cursor_column\(9)) # 
-- ((!\inst5|new_cursor_column\(7)) # ((!\inst5|new_cursor_column\(0) & \inst5|RECV_UART~3_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011111111111100101111000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_new_cursor_column\(0),
...
-- Equation(s):
-- \inst5|cursor_column~5_combout\ = ( \inst5|new_cursor_column\(9) & ( \inst5|new_cursor_column\(0) & ( (\inst5|new_cursor_column\(5) & (!\inst5|new_cursor_column\(7) & !\inst5|new_cursor_column\(8))) ) ) ) # ( !\inst5|new_cursor_column\(9) & ( 
-- \inst5|new_cursor_column\(0) & ( \inst5|new_cursor_column\(5) ) ) ) # ( \inst5|new_cursor_column\(9) & ( !\inst5|new_cursor_column\(0) & ( (\inst5|new_cursor_column\(5) & (!\inst5|new_cursor_column\(8) & ((!\inst5|new_cursor_column\(7)) # 
-- (\inst5|RECV_UART~3_combout\)))) ) ) ) # ( !\inst5|new_cursor_column\(9) & ( !\inst5|new_cursor_column\(0) & ( \inst5|new_cursor_column\(5) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101010100010000000001010101010101010101000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|cursor_column~6_combout\ = ( \inst5|new_cursor_column\(8) & ( \inst5|new_cursor_column\(4) & ( !\inst5|new_cursor_column\(9) ) ) ) # ( !\inst5|new_cursor_column\(8) & ( \inst5|new_cursor_column\(4) & ( (!\inst5|new_cursor_column\(9)) # 
-- ((!\inst5|new_cursor_column\(7)) # ((!\inst5|new_cursor_column\(0) & \inst5|RECV_UART~3_combout\))) ) ) )
...
-- Equation(s):
-- \inst5|Add5~9_sumout\ = SUM(( \inst5|PACKET_CHAR2\(5) ) + ( \inst5|cursor_column\(5) ) + ( \inst5|Add5~14\ ))
-- \inst5|Add5~10\ = CARRY(( \inst5|PACKET_CHAR2\(5) ) + ( \inst5|cursor_column\(5) ) + ( \inst5|Add5~14\ ))
...
-- Equation(s):
-- \inst5|RECV_UART~3_combout\ = ( !\inst5|new_cursor_column\(2) & ( !\inst5|new_cursor_column\(4) & ( (!\inst5|new_cursor_column\(3) & (!\inst5|new_cursor_column\(5) & (!\inst5|new_cursor_column\(1) & !\inst5|new_cursor_column\(6)))) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111000000000000111100000000000000111000000000000011100000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_new_cursor_column\(0),
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100001111000011110000111100001100110011001100110011111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \inst5|ALT_INV_cursor_column\(9),
...
-- Equation(s):
-- \inst7|SevenSeg_out[5]~6_combout\ = ( \inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) ) ) # ( !\inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( !\inst5|cursor_column\(9) $ (\inst5|cursor_column\(8)) ) ) ) # ( \inst5|cursor_column\(7) & ( 
-- !\inst5|cursor_column\(6) & ( (!\inst5|cursor_column\(8)) # (\inst5|cursor_column\(9)) ) ) ) # ( !\inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( (\inst5|cursor_column\(9) & \inst5|cursor_column\(8)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000101111101011111010110100101101001011111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst7|SevenSeg_out[4]~1_combout\ = ( \inst5|cursor_column\(8) & ( \inst5|cursor_column\(6) ) ) # ( !\inst5|cursor_column\(8) & ( \inst5|cursor_column\(6) ) ) # ( \inst5|cursor_column\(8) & ( !\inst5|cursor_column\(6) & ( (!\inst5|cursor_column\(7)) # 
-- (\inst5|cursor_column\(9)) ) ) ) # ( !\inst5|cursor_column\(8) & ( !\inst5|cursor_column\(6) & ( (\inst5|cursor_column\(7) & \inst5|cursor_column\(9)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001010101101010101111111111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_column\(7),
...
-- Equation(s):
-- \inst7|SevenSeg_out[3]~5_combout\ = ( \inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( (\inst5|cursor_column\(8)) # (\inst5|cursor_column\(9)) ) ) ) # ( !\inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( !\inst5|cursor_column\(9) $ 
-- (\inst5|cursor_column\(8)) ) ) ) # ( \inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( \inst5|cursor_column\(9) ) ) ) # ( !\inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( \inst5|cursor_column\(8) ) ) )
...
-- Equation(s):
-- \inst7|SevenSeg_out[2]~4_combout\ = ( \inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( \inst5|cursor_column\(9) ) ) ) # ( !\inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( (\inst5|cursor_column\(8) & \inst5|cursor_column\(9)) ) ) ) # ( 
-- \inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( (!\inst5|cursor_column\(8)) # (\inst5|cursor_column\(9)) ) ) ) # ( !\inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( (\inst5|cursor_column\(8) & \inst5|cursor_column\(9)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001010101101010101111111100000000010101010000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst7|SevenSeg_out[1]~3_combout\ = ( \inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( !\inst5|cursor_column\(9) ) ) ) # ( !\inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( !\inst5|cursor_column\(8) ) ) ) # ( \inst5|cursor_column\(7) & ( 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111110101010101010100000000010101010101010101111111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_column\(8),
...
-- Equation(s):
-- \inst7|SevenSeg_out[0]~2_combout\ = ( \inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( \inst5|cursor_column\(9) ) ) ) # ( !\inst5|cursor_column\(7) & ( \inst5|cursor_column\(6) & ( !\inst5|cursor_column\(9) $ (\inst5|cursor_column\(8)) ) ) ) # ( 
-- \inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( \inst5|cursor_column\(9) ) ) ) # ( !\inst5|cursor_column\(7) & ( !\inst5|cursor_column\(6) & ( \inst5|cursor_column\(8) ) ) )
...
-- Equation(s):
-- \inst5|PACKET_CHAR1[1]~1_combout\ = ( !\inst5|PACKET_COUNT\(1) & ( (\inst5|READ_CHAR~q\ & (!\inst5|mouse_state.WAIT_OUTPUT_READY~q\ & (\inst5|PACKET_COUNT\(0) & \inst5|LessThan1~0_combout\))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_PACKET_CHAR1\(1),
...
-- Equation(s):
-- \inst2|LessThan6~0_combout\ = ( \inst2|h_count\(7) & ( !\inst2|h_count[9]~DUPLICATE_q\ ) ) # ( !\inst2|h_count\(7) & ( (!\inst2|h_count[9]~DUPLICATE_q\) # (!\inst2|h_count\(8)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111001100111111111100110011001100110011001100110011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \inst2|ALT_INV_h_count[9]~DUPLICATE_q\,
...
-- Equation(s):
-- \inst3|LessThan0~0_combout\ = ( \inst2|pixel_column\(3) & ( \inst2|pixel_column\(4) & ( (\inst2|pixel_column\(5) & \inst2|pixel_column[6]~DUPLICATE_q\) ) ) ) # ( !\inst2|pixel_column\(3) & ( \inst2|pixel_column\(4) & ( (\inst2|pixel_column\(5) & 
-- \inst2|pixel_column[6]~DUPLICATE_q\) ) ) ) # ( !\inst2|pixel_column\(3) & ( !\inst2|pixel_column\(4) & ( (!\inst2|pixel_column\(5) & (!\inst2|pixel_column[6]~DUPLICATE_q\ & ((!\inst2|pixel_column\(2)) # (!\inst2|pixel_column\(1))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010100000000000000000000000000000000000010101010000000001010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \inst2|ALT_INV_pixel_column[6]~DUPLICATE_q\,
...
-- Equation(s):
-- \inst3|LessThan1~0_combout\ = ( \inst2|pixel_column\(5) & ( (\inst2|pixel_column\(1) & (\inst2|pixel_column\(2) & (\inst2|pixel_column\(7) & \inst2|pixel_column\(0)))) ) )
...
-- Equation(s):
-- \inst3|ball_on~0_combout\ = ( !\inst2|pixel_column\(8) & ( !\inst2|pixel_column\(9) ) )
...
-- Equation(s):
-- \inst3|LessThan5~0_combout\ = ( \inst3|ball_y_pos\(0) & ( \inst3|ball_y_pos\(1) & ( (!\inst3|ball_y_pos\(2) & (!\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & !\inst3|ball_y_pos\(3)))) ) ) ) # ( !\inst3|ball_y_pos\(0) & ( \inst3|ball_y_pos\(1) & ( 
-- (!\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & !\inst3|ball_y_pos\(3))) ) ) ) # ( \inst3|ball_y_pos\(0) & ( !\inst3|ball_y_pos\(1) & ( (!\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & !\inst3|ball_y_pos\(3))) ) ) ) # ( !\inst3|ball_y_pos\(0) & ( 
-- !\inst3|ball_y_pos\(1) & ( (!\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & !\inst3|ball_y_pos\(3))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000000000000110000000000000011000000000000001000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \inst3|ALT_INV_ball_y_pos\(0),
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010001010100010101000101010001000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|Add7~5_sumout\ = SUM(( \inst3|ball_y_pos\(3) ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~10\ ))
-- \inst3|Add7~6\ = CARRY(( \inst3|ball_y_pos\(3) ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~10\ ))
...
-- Equation(s):
-- \inst3|ball_y_pos[3]~feeder_combout\ = ( \inst3|Add7~5_sumout\ )
...
-- Equation(s):
-- \inst3|Add7~25_sumout\ = SUM(( \inst3|ball_y_pos\(4) ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~6\ ))
-- \inst3|Add7~26\ = CARRY(( \inst3|ball_y_pos\(4) ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~6\ ))
...
-- pragma translate_on
PORT MAP (
	dataf => \inst3|ALT_INV_Add7~25_sumout\,
	combout => \inst3|ball_y_pos[4]~feeder_combout\);

-- Location: FF_X20_Y22_N20
...
-- Equation(s):
-- \inst3|Add7~21_sumout\ = SUM(( \inst3|ball_y_pos[5]~DUPLICATE_q\ ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~26\ ))
-- \inst3|Add7~22\ = CARRY(( \inst3|ball_y_pos[5]~DUPLICATE_q\ ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~26\ ))
...
-- Equation(s):
-- \inst3|LessThan4~1_combout\ = ( !\inst3|ball_y_pos\(8) & ( (!\inst3|ball_y_pos\(6) & (!\inst3|ball_y_pos\(7) & !\inst3|ball_y_pos\(5))) ) )
...
-- Equation(s):
-- \inst3|ball_y_motion~2_combout\ = ( \inst3|LessThan4~1_combout\ & ( \inst5|left_button~q\ & ( (\inst3|LessThan4~0_combout\ & !\inst3|ball_y_pos\(9)) ) ) ) # ( !\inst3|LessThan4~1_combout\ & ( \inst5|left_button~q\ & ( !\inst3|ball_y_pos\(9) ) ) ) # ( 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000001100110011000000110011001100110011000100010001000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|LessThan4~0_combout\ = ( \inst3|ball_y_pos\(2) & ( (\inst3|ball_y_pos\(4) & \inst3|ball_y_pos\(3)) ) ) # ( !\inst3|ball_y_pos\(2) & ( (\inst3|ball_y_pos\(4) & (\inst3|ball_y_pos\(3) & ((\inst3|ball_y_pos\(1)) # (\inst3|ball_y_pos\(0))))) ) )
...
-- Equation(s):
-- \inst3|ball_on~1_combout\ = ( \inst2|pixel_column\(7) & ( !\inst3|ball_y_pos\(9) & ( (!\inst2|pixel_column[6]~DUPLICATE_q\ & ((!\inst2|pixel_column\(5)) # ((!\inst2|pixel_column[3]~DUPLICATE_q\ & !\inst2|pixel_column\(4))))) ) ) ) # ( 
-- !\inst2|pixel_column\(7) & ( !\inst3|ball_y_pos\(9) & ( (\inst2|pixel_column\(4) & (\inst2|pixel_column\(5) & \inst2|pixel_column[6]~DUPLICATE_q\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000011111110000000000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|LessThan0~1_combout\ = ( \inst2|pixel_column\(2) & ( !\inst2|pixel_column[3]~DUPLICATE_q\ & ( (!\inst2|pixel_column\(5) & (!\inst2|pixel_column\(4) & (!\inst2|pixel_column\(1) & !\inst2|pixel_column[6]~DUPLICATE_q\))) ) ) ) # ( 
-- !\inst2|pixel_column\(2) & ( !\inst2|pixel_column[3]~DUPLICATE_q\ & ( (!\inst2|pixel_column\(5) & (!\inst2|pixel_column\(4) & !\inst2|pixel_column[6]~DUPLICATE_q\)) ) ) )
...
-- Equation(s):
-- \inst2|LessThan7~1_combout\ = ( \inst2|v_count\(8) & ( (!\inst2|v_count\(9) & ((!\inst2|v_count\(6)) # ((!\inst2|v_count\(5)) # (!\inst2|v_count[7]~DUPLICATE_q\)))) ) ) # ( !\inst2|v_count\(8) & ( !\inst2|v_count\(9) ) )
...
-- Equation(s):
-- \inst3|ball_on~2_combout\ = ( \inst2|pixel_row\(8) & ( \inst3|Add3~0_combout\ & ( (!\inst3|ball_y_pos\(8) & (\inst3|ball_on~1_combout\ & (!\inst3|LessThan0~1_combout\ & !\inst3|Add2~0_combout\))) ) ) ) # ( !\inst2|pixel_row\(8) & ( \inst3|Add3~0_combout\ 
-- & ( (!\inst3|ball_y_pos\(8) & (\inst3|ball_on~1_combout\ & !\inst3|LessThan0~1_combout\)) ) ) ) # ( \inst2|pixel_row\(8) & ( !\inst3|Add3~0_combout\ & ( (\inst3|ball_y_pos\(8) & (\inst3|ball_on~1_combout\ & (!\inst3|LessThan0~1_combout\ & 
-- !\inst3|Add2~0_combout\))) ) ) ) # ( !\inst2|pixel_row\(8) & ( !\inst3|Add3~0_combout\ & ( (\inst3|ball_on~1_combout\ & (!\inst3|LessThan0~1_combout\ & ((!\inst3|ball_y_pos\(8)) # (\inst3|Add2~0_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000110000000100000000000000100000001000000010000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|ball_on~3_combout\ = ( \inst3|ball_on~0_combout\ & ( \inst3|ball_on~2_combout\ & ( (!\inst3|LessThan1~0_combout\ & ((!\inst3|LessThan0~0_combout\) # (\inst2|pixel_column\(7)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000000001100111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|LessThan3~0_combout\ = ( \inst3|ball_y_pos\(1) & ( (!\inst3|ball_y_pos\(0) & (\inst2|pixel_row\(1) & \inst2|pixel_row\(0))) ) ) # ( !\inst3|ball_y_pos\(1) & ( ((!\inst3|ball_y_pos\(0) & \inst2|pixel_row\(0))) # (\inst2|pixel_row\(1)) ) )
...
-- Equation(s):
-- \inst3|LessThan3~1_combout\ = ( \inst3|LessThan3~0_combout\ & ( (!\inst2|pixel_row\(3) & (!\inst3|ball_y_pos\(3) & ((!\inst3|ball_y_pos\(2)) # (\inst2|pixel_row\(2))))) # (\inst2|pixel_row\(3) & ((!\inst3|ball_y_pos\(3)) # ((!\inst3|ball_y_pos\(2)) # 
-- (\inst2|pixel_row\(2))))) ) ) # ( !\inst3|LessThan3~0_combout\ & ( (!\inst2|pixel_row\(3) & (!\inst3|ball_y_pos\(3) & (\inst2|pixel_row\(2) & !\inst3|ball_y_pos\(2)))) # (\inst2|pixel_row\(3) & ((!\inst3|ball_y_pos\(3)) # ((\inst2|pixel_row\(2) & 
-- !\inst3|ball_y_pos\(2))))) ) )
...
-- Equation(s):
-- \inst3|LessThan3~2_combout\ = ( \inst2|pixel_row\(7) & ( \inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(6) & (!\inst2|pixel_row\(6) $ (((\inst3|ball_y_pos\(5) & \inst3|ball_y_pos\(4)))))) # (\inst3|ball_y_pos\(6) & (\inst2|pixel_row\(6) & 
-- ((!\inst3|ball_y_pos\(5)) # (!\inst3|ball_y_pos\(4))))) ) ) ) # ( !\inst2|pixel_row\(7) & ( \inst3|ball_y_pos\(7) & ( (\inst3|ball_y_pos\(5) & (\inst3|ball_y_pos\(4) & (\inst3|ball_y_pos\(6) & !\inst2|pixel_row\(6)))) ) ) ) # ( \inst2|pixel_row\(7) & ( 
-- !\inst3|ball_y_pos\(7) & ( (\inst3|ball_y_pos\(5) & (\inst3|ball_y_pos\(4) & (\inst3|ball_y_pos\(6) & !\inst2|pixel_row\(6)))) ) ) ) # ( !\inst2|pixel_row\(7) & ( !\inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(6) & (!\inst2|pixel_row\(6) $ 
-- (((\inst3|ball_y_pos\(5) & \inst3|ball_y_pos\(4)))))) # (\inst3|ball_y_pos\(6) & (\inst2|pixel_row\(6) & ((!\inst3|ball_y_pos\(5)) # (!\inst3|ball_y_pos\(4))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1110000000011110000000010000000000000001000000001110000000011110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000010100100000100001010010000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(4),
...
-- Equation(s):
-- \inst3|LessThan3~4_combout\ = ( \inst2|pixel_row\(7) & ( \inst3|ball_y_pos\(4) & ( (!\inst2|pixel_row\(6) & (!\inst3|ball_y_pos\(7) $ (((\inst3|ball_y_pos\(5) & \inst3|ball_y_pos\(6)))))) # (\inst2|pixel_row\(6) & ((!\inst3|ball_y_pos\(7)) # 
-- (!\inst3|ball_y_pos\(5) $ (\inst3|ball_y_pos\(6))))) ) ) ) # ( !\inst2|pixel_row\(7) & ( \inst3|ball_y_pos\(4) & ( (\inst2|pixel_row\(6) & ((!\inst3|ball_y_pos\(5) & (!\inst3|ball_y_pos\(7) & !\inst3|ball_y_pos\(6))) # (\inst3|ball_y_pos\(5) & 
-- (\inst3|ball_y_pos\(7) & \inst3|ball_y_pos\(6))))) ) ) ) # ( \inst2|pixel_row\(7) & ( !\inst3|ball_y_pos\(4) & ( (!\inst3|ball_y_pos\(7)) # ((!\inst3|ball_y_pos\(6) & \inst2|pixel_row\(6))) ) ) ) # ( !\inst2|pixel_row\(7) & ( !\inst3|ball_y_pos\(4) & ( 
-- (!\inst3|ball_y_pos\(7) & (!\inst3|ball_y_pos\(6) & \inst2|pixel_row\(6))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011000000110011001111110000000000100000011100100111101101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(5),
...
-- Equation(s):
-- \inst3|LessThan3~5_combout\ = ( \inst3|LessThan3~2_combout\ & ( \inst3|ball_y_pos\(5) & ( (!\inst3|LessThan3~4_combout\ & ((!\inst3|ball_y_pos\(4)) # ((!\inst2|pixel_row\(4) & !\inst2|pixel_row\(5))))) ) ) ) # ( !\inst3|LessThan3~2_combout\ & ( 
-- \inst3|ball_y_pos\(5) & ( !\inst3|LessThan3~4_combout\ ) ) ) # ( \inst3|LessThan3~2_combout\ & ( !\inst3|ball_y_pos\(5) & ( (!\inst3|LessThan3~4_combout\ & ((!\inst2|pixel_row\(5)) # ((\inst3|ball_y_pos\(4) & !\inst2|pixel_row\(4))))) ) ) ) # ( 
-- !\inst3|LessThan3~2_combout\ & ( !\inst3|ball_y_pos\(5) & ( !\inst3|LessThan3~4_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011001100110011000100000011001100110011001100100010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(4),
...
-- Equation(s):
-- \inst3|LessThan3~6_combout\ = ( \inst3|LessThan3~5_combout\ & ( \inst3|ball_y_pos\(8) & ( (\inst3|LessThan3~1_combout\ & (\inst3|LessThan3~3_combout\ & (!\inst3|Add3~0_combout\ $ (!\inst2|pixel_row\(8))))) ) ) ) # ( !\inst3|LessThan3~5_combout\ & ( 
-- \inst3|ball_y_pos\(8) & ( !\inst3|Add3~0_combout\ $ (!\inst2|pixel_row\(8)) ) ) ) # ( \inst3|LessThan3~5_combout\ & ( !\inst3|ball_y_pos\(8) & ( (\inst3|LessThan3~1_combout\ & (\inst3|LessThan3~3_combout\ & (!\inst3|Add3~0_combout\ $ 
-- (\inst2|pixel_row\(8))))) ) ) ) # ( !\inst3|LessThan3~5_combout\ & ( !\inst3|ball_y_pos\(8) & ( !\inst3|Add3~0_combout\ $ (\inst2|pixel_row\(8)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100001111000011000000000100000100111100001111000000000000010100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
\inst8|LessThan4~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst8|LessThan4~0_combout\ = ( !\inst2|pixel_column\(0) & ( (!\inst2|pixel_column\(1) & (!\inst2|pixel_column\(2) & !\inst2|pixel_column\(3))) ) )
...
-- Equation(s):
-- \inst8|char_address~0_combout\ = ( !\inst2|pixel_row\(7) & ( (!\inst2|pixel_column\(7) & (!\inst2|pixel_row\(6) & (!\inst2|pixel_column\(6) & !\inst2|pixel_row\(8)))) ) )
...
-- Equation(s):
-- \inst8|char_address~1_combout\ = ( \inst2|pixel_row[0]~DUPLICATE_q\ & ( \inst2|pixel_row\(4) & ( \inst2|pixel_row\(5) ) ) ) # ( !\inst2|pixel_row[0]~DUPLICATE_q\ & ( \inst2|pixel_row\(4) & ( \inst2|pixel_row\(5) ) ) ) # ( \inst2|pixel_row[0]~DUPLICATE_q\ 
-- & ( !\inst2|pixel_row\(4) & ( (\inst2|pixel_row\(3) & (\inst2|pixel_row\(5) & \inst2|pixel_row\(2))) ) ) ) # ( !\inst2|pixel_row[0]~DUPLICATE_q\ & ( !\inst2|pixel_row\(4) & ( (!\inst2|pixel_row\(1) & (!\inst2|pixel_row\(3) & (!\inst2|pixel_row\(5) & 
-- !\inst2|pixel_row\(2)))) # (\inst2|pixel_row\(1) & (\inst2|pixel_row\(3) & (\inst2|pixel_row\(5) & \inst2|pixel_row\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1000000000000001000000000000001100001111000011110000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
\inst8|char_address[0]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst8|char_address[0]~2_combout\ = ( \inst3|ball_on~0_combout\ & ( !\inst2|pixel_column\(4) & ( (!\inst8|LessThan4~0_combout\ & (\inst8|char_address~0_combout\ & !\inst8|char_address~1_combout\)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \inst8|ALT_INV_LessThan4~0_combout\,
	datac => \inst8|ALT_INV_char_address~0_combout\,
	datad => \inst8|ALT_INV_char_address~1_combout\,
	datae => \inst3|ALT_INV_ball_on~0_combout\,
	dataf => \inst2|ALT_INV_pixel_column\(4),
	combout => \inst8|char_address[0]~2_combout\);

-- Location: LABCELL_X21_Y22_N36
\inst8|char_address[1]~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst8|char_address[1]~3_combout\ = ( \inst3|ball_on~0_combout\ & ( \inst2|pixel_column\(5) & ( (!\inst8|LessThan4~0_combout\ & (!\inst2|pixel_column\(4) & (!\inst8|char_address~1_combout\ & \inst8|char_address~0_combout\))) ) ) ) # ( 
-- \inst3|ball_on~0_combout\ & ( !\inst2|pixel_column\(5) & ( (!\inst8|LessThan4~0_combout\ & (\inst2|pixel_column\(4) & (!\inst8|char_address~1_combout\ & \inst8|char_address~0_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000010000000000000000000000000000010000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst8|ALT_INV_LessThan4~0_combout\,
	datab => \inst2|ALT_INV_pixel_column\(4),
	datac => \inst8|ALT_INV_char_address~1_combout\,
	datad => \inst8|ALT_INV_char_address~0_combout\,
	datae => \inst3|ALT_INV_ball_on~0_combout\,
	dataf => \inst2|ALT_INV_pixel_column\(5),
	combout => \inst8|char_address[1]~3_combout\);

-- Location: LABCELL_X21_Y22_N18
\inst8|char_address[2]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst8|char_address[2]~4_combout\ = ( !\inst8|char_address~1_combout\ & ( \inst8|char_address~0_combout\ & ( (!\inst8|LessThan4~0_combout\ & (\inst3|ball_on~0_combout\ & (\inst2|pixel_column\(5) & \inst2|pixel_column\(4)))) ) ) )
...
PORT MAP (
	...
	datae => \inst8|ALT_INV_char_address~1_combout\,
	dataf => \inst8|ALT_INV_char_address~0_combout\,
	combout => \inst8|char_address[2]~4_combout\);

-- Location: LABCELL_X21_Y22_N3
\inst8|char_address[5]~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst8|char_address[5]~5_combout\ = ( \inst3|ball_on~0_combout\ & ( \inst8|char_address~0_combout\ & ( (\inst8|char_address~1_combout\) # (\inst8|LessThan4~0_combout\) ) ) ) # ( !\inst3|ball_on~0_combout\ & ( \inst8|char_address~0_combout\ ) ) # ( 
-- \inst3|ball_on~0_combout\ & ( !\inst8|char_address~0_combout\ ) ) # ( !\inst3|ball_on~0_combout\ & ( !\inst8|char_address~0_combout\ ) )
...
PORT MAP (
	...
	datae => \inst3|ALT_INV_ball_on~0_combout\,
	dataf => \inst8|ALT_INV_char_address~0_combout\,
	combout => \inst8|char_address[5]~5_combout\);
...
-- Equation(s):
-- \inst9|Mux0~4_combout\ = ( !\inst2|pixel_column\(2) & ( (!\inst2|pixel_column\(1) & (((\inst9|altsyncram_component|auto_generated|q_a\(7) & ((!\inst2|pixel_column[3]~DUPLICATE_q\)))))) # (\inst2|pixel_column\(1) & ((((\inst2|pixel_column[3]~DUPLICATE_q\) 
-- # (\inst9|altsyncram_component|auto_generated|q_a\(6)))))) ) ) # ( \inst2|pixel_column\(2) & ( (!\inst2|pixel_column\(1) & (((\inst9|altsyncram_component|auto_generated|q_a\(5) & ((!\inst2|pixel_column[3]~DUPLICATE_q\)))))) # (\inst2|pixel_column\(1) & 
-- ((((\inst2|pixel_column[3]~DUPLICATE_q\))) # (\inst9|altsyncram_component|auto_generated|q_a\(4)))) ) )
...
-- Equation(s):
-- \inst9|Mux0~0_combout\ = ( !\inst2|pixel_column\(2) & ( ((!\inst9|Mux0~4_combout\ & (((\inst9|altsyncram_component|auto_generated|q_a\(3) & \inst2|pixel_column[3]~DUPLICATE_q\)))) # (\inst9|Mux0~4_combout\ & (((!\inst2|pixel_column[3]~DUPLICATE_q\)) # 
-- (\inst9|altsyncram_component|auto_generated|q_a\(2))))) ) ) # ( \inst2|pixel_column\(2) & ( ((!\inst9|Mux0~4_combout\ & (((\inst9|altsyncram_component|auto_generated|q_a\(1) & \inst2|pixel_column[3]~DUPLICATE_q\)))) # (\inst9|Mux0~4_combout\ & 
-- (((!\inst2|pixel_column[3]~DUPLICATE_q\)) # (\inst9|altsyncram_component|auto_generated|q_a\(0))))) ) )
...
-- Equation(s):
-- \inst3|LessThan2~2_combout\ = ( \inst2|pixel_row\(7) & ( \inst2|pixel_row\(5) & ( (!\inst2|pixel_row\(4) & (\inst3|ball_y_pos\(7) & (!\inst2|pixel_row\(6) $ (\inst3|ball_y_pos\(6))))) # (\inst2|pixel_row\(4) & ((!\inst2|pixel_row\(6) & 
-- (\inst3|ball_y_pos\(7) & \inst3|ball_y_pos\(6))) # (\inst2|pixel_row\(6) & (!\inst3|ball_y_pos\(7) & !\inst3|ball_y_pos\(6))))) ) ) ) # ( !\inst2|pixel_row\(7) & ( \inst2|pixel_row\(5) & ( (!\inst2|pixel_row\(4) & (!\inst3|ball_y_pos\(7) & 
-- (!\inst2|pixel_row\(6) $ (\inst3|ball_y_pos\(6))))) # (\inst2|pixel_row\(4) & ((!\inst2|pixel_row\(6) & (!\inst3|ball_y_pos\(7) & \inst3|ball_y_pos\(6))) # (\inst2|pixel_row\(6) & (\inst3|ball_y_pos\(7) & !\inst3|ball_y_pos\(6))))) ) ) ) # ( 
-- \inst2|pixel_row\(7) & ( !\inst2|pixel_row\(5) & ( (\inst3|ball_y_pos\(7) & (!\inst2|pixel_row\(6) $ (\inst3|ball_y_pos\(6)))) ) ) ) # ( !\inst2|pixel_row\(7) & ( !\inst2|pixel_row\(5) & ( (!\inst3|ball_y_pos\(7) & (!\inst2|pixel_row\(6) $ 
-- (\inst3|ball_y_pos\(6)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000000110000000011000000001110000001011000000001100000000110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|LessThan2~4_combout\ = ( \inst2|pixel_row\(7) & ( \inst3|ball_y_pos\(7) & ( (!\inst2|pixel_row\(6) & (\inst3|ball_y_pos\(6) & ((!\inst2|pixel_row\(4)) # (!\inst2|pixel_row\(5))))) # (\inst2|pixel_row\(6) & (((\inst2|pixel_row\(4) & 
-- \inst2|pixel_row\(5))))) ) ) ) # ( !\inst2|pixel_row\(7) & ( \inst3|ball_y_pos\(7) & ( ((!\inst2|pixel_row\(6)) # ((!\inst2|pixel_row\(4)) # (!\inst2|pixel_row\(5)))) # (\inst3|ball_y_pos\(6)) ) ) ) # ( \inst2|pixel_row\(7) & ( !\inst3|ball_y_pos\(7) & ( 
-- (\inst3|ball_y_pos\(6) & (\inst2|pixel_row\(6) & (\inst2|pixel_row\(4) & \inst2|pixel_row\(5)))) ) ) ) # ( !\inst2|pixel_row\(7) & ( !\inst3|ball_y_pos\(7) & ( (\inst3|ball_y_pos\(6) & (!\inst2|pixel_row\(6) & ((!\inst2|pixel_row\(4)) # 
-- (!\inst2|pixel_row\(5))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100010001000000000000000000000111111111111111010100010001000011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(6),
...
-- Equation(s):
-- \inst3|LessThan2~5_combout\ = ( \inst3|ball_y_pos\(4) & ( \inst3|ball_y_pos\(5) & ( (!\inst3|LessThan2~4_combout\ & ((!\inst3|LessThan2~2_combout\) # ((!\inst2|pixel_row\(4) & \inst2|pixel_row\(5))))) ) ) ) # ( !\inst3|ball_y_pos\(4) & ( 
-- \inst3|ball_y_pos\(5) & ( (!\inst3|LessThan2~4_combout\ & ((!\inst3|LessThan2~2_combout\) # (!\inst2|pixel_row\(4) $ (!\inst2|pixel_row\(5))))) ) ) ) # ( \inst3|ball_y_pos\(4) & ( !\inst3|ball_y_pos\(5) & ( (!\inst3|LessThan2~4_combout\ & 
-- ((!\inst2|pixel_row\(4)) # ((!\inst3|LessThan2~2_combout\) # (!\inst2|pixel_row\(5))))) ) ) ) # ( !\inst3|ball_y_pos\(4) & ( !\inst3|ball_y_pos\(5) & ( !\inst3|LessThan2~4_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111000011110000111100001110000011010000111000001100000011100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_pixel_row\(4),
	datab => \inst3|ALT_INV_LessThan2~2_combout\,
	datac => \inst3|ALT_INV_LessThan2~4_combout\,
	datad => \inst2|ALT_INV_pixel_row\(5),
...
-- Equation(s):
-- \inst3|LessThan2~3_combout\ = ( \inst2|pixel_row\(5) & ( (\inst3|LessThan2~2_combout\ & ((!\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & \inst2|pixel_row\(4))) # (\inst3|ball_y_pos\(4) & (\inst3|ball_y_pos\(5) & !\inst2|pixel_row\(4))))) ) ) # ( 
-- !\inst2|pixel_row\(5) & ( (\inst3|LessThan2~2_combout\ & ((!\inst3|ball_y_pos\(4) & (\inst3|ball_y_pos\(5) & \inst2|pixel_row\(4))) # (\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & !\inst2|pixel_row\(4))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010000000010000001000000001000000001000010000000000100001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(4),
...
-- Equation(s):
-- \inst3|LessThan2~0_combout\ = ( \inst3|ball_y_pos\(1) & ( (!\inst2|pixel_row\(1)) # ((!\inst2|pixel_row\(0) & \inst3|ball_y_pos\(0))) ) ) # ( !\inst3|ball_y_pos\(1) & ( (!\inst2|pixel_row\(1) & (!\inst2|pixel_row\(0) & \inst3|ball_y_pos\(0))) ) )
...
-- Equation(s):
-- \inst3|LessThan2~1_combout\ = ( \inst2|pixel_row\(2) & ( (!\inst2|pixel_row\(3) & (((\inst3|LessThan2~0_combout\ & \inst3|ball_y_pos\(2))) # (\inst3|ball_y_pos\(3)))) # (\inst2|pixel_row\(3) & (\inst3|ball_y_pos\(3) & (\inst3|LessThan2~0_combout\ & 
-- \inst3|ball_y_pos\(2)))) ) ) # ( !\inst2|pixel_row\(2) & ( (!\inst2|pixel_row\(3) & (((\inst3|ball_y_pos\(2)) # (\inst3|LessThan2~0_combout\)) # (\inst3|ball_y_pos\(3)))) # (\inst2|pixel_row\(3) & (\inst3|ball_y_pos\(3) & ((\inst3|ball_y_pos\(2)) # 
...
-- Equation(s):
-- \inst3|LessThan2~6_combout\ = ( \inst3|LessThan2~1_combout\ & ( \inst3|ball_y_pos\(8) & ( (!\inst3|LessThan2~5_combout\ & (!\inst2|pixel_row\(8) $ (((!\inst3|Add2~0_combout\))))) # (\inst3|LessThan2~5_combout\ & (\inst3|LessThan2~3_combout\ & 
...
-- !\inst3|ball_y_pos\(8) & ( (!\inst3|LessThan2~5_combout\ & (!\inst2|pixel_row\(8) $ (((\inst3|Add2~0_combout\))))) # (\inst3|LessThan2~5_combout\ & (\inst3|LessThan2~3_combout\ & (!\inst2|pixel_row\(8) $ (\inst3|Add2~0_combout\)))) ) ) ) # ( 
-- !\inst3|LessThan2~1_combout\ & ( !\inst3|ball_y_pos\(8) & ( (!\inst3|LessThan2~5_combout\ & (!\inst2|pixel_row\(8) $ (\inst3|Add2~0_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1000100000100010100011000010001100100010100010000010001110001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_LessThan2~5_combout\,
	datab => \inst2|ALT_INV_pixel_row\(8),
	datac => \inst3|ALT_INV_LessThan2~3_combout\,
	datad => \inst3|ALT_INV_Add2~0_combout\,
...
-- Equation(s):
-- \inst2|blue_out~0_combout\ = ( !\inst9|Mux0~0_combout\ & ( \inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & \inst2|video_on_h~q\) ) ) ) # ( !\inst9|Mux0~0_combout\ & ( !\inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & (\inst2|video_on_h~q\ & 
-- ((!\inst3|ball_on~3_combout\) # (\inst3|LessThan3~6_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001011000000000000000000000000000011110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst2|green_out~0_combout\ = ( \inst9|Mux0~0_combout\ & ( \inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & \inst2|video_on_h~q\) ) ) ) # ( !\inst9|Mux0~0_combout\ & ( \inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & \inst2|video_on_h~q\) ) 
-- ) ) # ( \inst9|Mux0~0_combout\ & ( !\inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & \inst2|video_on_h~q\) ) ) ) # ( !\inst9|Mux0~0_combout\ & ( !\inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & (\inst2|video_on_h~q\ & 
-- ((!\inst3|ball_on~3_combout\) # (\inst3|LessThan3~6_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001011000000000000111100000000000011110000000000001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_on~3_combout\,
...
-- Equation(s):
-- \inst2|red_out~0_combout\ = ( \inst9|Mux0~0_combout\ & ( \inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & \inst2|video_on_h~q\) ) ) ) # ( \inst9|Mux0~0_combout\ & ( !\inst3|LessThan2~6_combout\ & ( (\inst2|video_on_v~q\ & \inst2|video_on_h~q\) ) ) 
-- ) # ( !\inst9|Mux0~0_combout\ & ( !\inst3|LessThan2~6_combout\ & ( (\inst3|ball_on~3_combout\ & (!\inst3|LessThan3~6_combout\ & (\inst2|video_on_v~q\ & \inst2|video_on_h~q\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000100000000000000111100000000000000000000000000001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_on~3_combout\,
