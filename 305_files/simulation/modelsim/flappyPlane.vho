...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = ( \inst2|h_count[1]~DUPLICATE_q\ & ( !\inst2|h_count[6]~DUPLICATE_q\ & ( (\inst2|h_count\(0) & (\inst2|h_count[3]~DUPLICATE_q\ & (\inst2|h_count[9]~DUPLICATE_q\ & \inst2|h_count[4]~DUPLICATE_q\))) ) ) )
...
-- Equation(s):
-- \inst2|Equal0~1_combout\ = ( \inst2|Equal0~0_combout\ & ( (\inst2|h_count\(8) & (!\inst2|h_count\(7) & (\inst2|h_count[2]~DUPLICATE_q\ & !\inst2|h_count[5]~DUPLICATE_q\))) ) )
...
-- Equation(s):
-- \inst2|v_count[9]~0_combout\ = ( \inst2|Equal0~0_combout\ & ( \inst2|process_0~10_combout\ ) ) # ( !\inst2|Equal0~0_combout\ & ( \inst2|process_0~10_combout\ ) ) # ( \inst2|Equal0~0_combout\ & ( !\inst2|process_0~10_combout\ & ( 
-- (\inst2|h_count[5]~DUPLICATE_q\ & (!\inst2|h_count[8]~DUPLICATE_q\ & (!\inst2|h_count[2]~DUPLICATE_q\ & \inst2|h_count[7]~DUPLICATE_q\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_h_count[5]~DUPLICATE_q\,
...
-- Equation(s):
-- \inst2|process_0~7_combout\ = ( !\inst2|v_count\(6) & ( (!\inst2|v_count\(7) & (!\inst2|v_count\(5) & (!\inst2|v_count\(4) & !\inst2|v_count\(8)))) ) )
...
-- Equation(s):
-- \inst2|process_0~6_combout\ = ( \inst2|h_count\(9) & ( (!\inst2|h_count\(8) & !\inst2|h_count[7]~DUPLICATE_q\) ) ) # ( !\inst2|h_count\(9) )
...
-- Equation(s):
-- \inst2|process_0~8_combout\ = ( \inst2|h_count[1]~DUPLICATE_q\ & ( \inst2|h_count[3]~DUPLICATE_q\ & ( (\inst2|h_count[5]~DUPLICATE_q\ & (\inst2|h_count\(4) & ((\inst2|h_count\(0)) # (\inst2|h_count\(2))))) ) ) ) # ( !\inst2|h_count[1]~DUPLICATE_q\ & ( 
-- \inst2|h_count[3]~DUPLICATE_q\ & ( (\inst2|h_count\(2) & (\inst2|h_count[5]~DUPLICATE_q\ & \inst2|h_count\(4))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000001000000010000000100000011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst2|process_0~10_combout\ = ( !\inst2|process_0~6_combout\ & ( \inst2|process_0~8_combout\ & ( (\inst2|v_count[9]~DUPLICATE_q\ & ((!\inst2|process_0~7_combout\) # (\inst2|process_0~0_combout\))) ) ) ) # ( !\inst2|process_0~6_combout\ & ( 
-- !\inst2|process_0~8_combout\ & ( (\inst2|v_count[9]~DUPLICATE_q\ & (!\inst2|process_0~9_combout\ & ((!\inst2|process_0~7_combout\) # (\inst2|process_0~0_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000100000000000000000000000001010001010100010000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_v_count[9]~DUPLICATE_q\,
	...
	dataf => \inst2|ALT_INV_process_0~8_combout\,
	combout => \inst2|process_0~10_combout\);

-- Location: FF_X21_Y41_N32
...
-- Equation(s):
-- \inst2|LessThan7~0_combout\ = ( \inst2|v_count\(7) & ( (\inst2|v_count\(5) & (\inst2|v_count[6]~DUPLICATE_q\ & \inst2|v_count[8]~DUPLICATE_q\)) ) )
...
PORT MAP (
	...
	datad => \inst2|ALT_INV_v_count[8]~DUPLICATE_q\,
...
-- Equation(s):
-- \inst2|process_0~1_combout\ = ( \inst2|v_count\(4) & ( \inst2|process_0~0_combout\ ) ) # ( !\inst2|v_count\(4) & ( \inst2|process_0~0_combout\ & ( (!\inst2|LessThan7~0_combout\) # ((!\inst2|v_count\(0) $ (\inst2|v_count\(1))) # (\inst2|v_count\(9))) ) ) ) 
-- # ( \inst2|v_count\(4) & ( !\inst2|process_0~0_combout\ ) ) # ( !\inst2|v_count\(4) & ( !\inst2|process_0~0_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111111111111111101011111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_LessThan7~0_combout\,
	datab => \inst2|ALT_INV_v_count\(0),
	datac => \inst2|ALT_INV_v_count\(1),
	datad => \inst2|ALT_INV_v_count\(9),
	datae => \inst2|ALT_INV_v_count\(4),
...
-- Equation(s):
-- \inst2|process_0~4_combout\ = ( \inst2|h_count[7]~DUPLICATE_q\ & ( (!\inst2|h_count[8]~DUPLICATE_q\ & \inst2|h_count[9]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \inst2|process_0~3_combout\ = ( \inst2|h_count\(1) & ( !\inst2|h_count[3]~DUPLICATE_q\ & ( (!\inst2|h_count[6]~DUPLICATE_q\ & (!\inst2|h_count[2]~DUPLICATE_q\ & (!\inst2|h_count[5]~DUPLICATE_q\ & !\inst2|h_count[0]~DUPLICATE_q\))) ) ) ) # ( 
-- !\inst2|h_count\(1) & ( !\inst2|h_count[3]~DUPLICATE_q\ & ( (!\inst2|h_count[6]~DUPLICATE_q\ & (!\inst2|h_count[2]~DUPLICATE_q\ & !\inst2|h_count[5]~DUPLICATE_q\)) ) ) )
...
-- Equation(s):
-- \inst2|process_0~2_combout\ = ( !\inst2|h_count[2]~DUPLICATE_q\ & ( !\inst2|h_count\(3) ) )
...
-- Equation(s):
-- \inst2|process_0~5_combout\ = ( \inst2|h_count[4]~DUPLICATE_q\ & ( \inst2|h_count\(6) & ( (!\inst2|process_0~4_combout\) # (((!\inst2|process_0~2_combout\ & \inst2|h_count\(5))) # (\inst2|process_0~3_combout\)) ) ) ) # ( !\inst2|h_count[4]~DUPLICATE_q\ & 
-- ( \inst2|h_count\(6) & ( (!\inst2|process_0~4_combout\) # (\inst2|process_0~3_combout\) ) ) ) # ( \inst2|h_count[4]~DUPLICATE_q\ & ( !\inst2|h_count\(6) & ( (!\inst2|process_0~4_combout\) # (\inst2|process_0~3_combout\) ) ) ) # ( 
-- !\inst2|h_count[4]~DUPLICATE_q\ & ( !\inst2|h_count\(6) & ( (!\inst2|process_0~4_combout\) # ((!\inst2|h_count\(5)) # (\inst2|process_0~3_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111110111011101110111011101110111011101110111011101111111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst2|LessThan7~1_combout\ = ( !\inst2|v_count[9]~DUPLICATE_q\ & ( (!\inst2|v_count[8]~DUPLICATE_q\) # ((!\inst2|v_count\(5)) # ((!\inst2|v_count\(7)) # (!\inst2|v_count[6]~DUPLICATE_q\))) ) )
...
-- Location: LABCELL_X20_Y41_N57
\inst2|blue_out~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst2|blue_out~0_combout\ = ( \SW[2]~input_o\ & ( \inst2|video_on_v~q\ & ( \inst2|video_on_h~q\ ) ) )
...
-- Location: LABCELL_X20_Y41_N15
\inst2|green_out~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst2|green_out~0_combout\ = ( \inst2|video_on_h~q\ & ( \inst2|video_on_v~q\ & ( \SW[1]~input_o\ ) ) )
...
-- Location: LABCELL_X20_Y41_N42
\inst2|red_out~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst2|red_out~0_combout\ = ( \inst2|video_on_h~q\ & ( \inst2|video_on_v~q\ & ( \SW[0]~input_o\ ) ) )
