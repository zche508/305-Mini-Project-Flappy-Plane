...
SIGNAL \inst5|new_cursor_column[7]~0_combout\ : std_logic;
...
SIGNAL \inst5|ALT_INV_new_cursor_column[7]~0_combout\ : std_logic;
...
\inst5|ALT_INV_new_cursor_column[7]~0_combout\ <= NOT \inst5|new_cursor_column[7]~0_combout\;
...
-- Equation(s):
-- \inst5|Equal2~0_combout\ = ( !\inst5|filter\(2) & ( !\inst5|filter\(1) & ( (!\inst5|filter\(3) & (!\inst5|filter\(0) & !\inst5|filter\(4))) ) ) )
...
-- Equation(s):
-- \inst5|Equal1~0_combout\ = ( \inst5|filter\(2) & ( (\inst5|filter\(1) & (\inst5|filter\(0) & (\inst5|filter\(4) & \inst5|filter\(3)))) ) )
...
-- Equation(s):
-- \inst5|MOUSE_CLK_FILTER~0_combout\ = ( \inst5|Equal1~0_combout\ & ( \inst5|MOUSE_CLK_FILTER~q\ & ( ((!\inst5|Equal2~0_combout\) # ((\inst5|filter\(6)) # (\inst5|filter\(7)))) # (\inst5|filter\(5)) ) ) ) # ( !\inst5|Equal1~0_combout\ & ( 
-- \inst5|MOUSE_CLK_FILTER~q\ & ( ((!\inst5|Equal2~0_combout\) # ((\inst5|filter\(6)) # (\inst5|filter\(7)))) # (\inst5|filter\(5)) ) ) ) # ( \inst5|Equal1~0_combout\ & ( !\inst5|MOUSE_CLK_FILTER~q\ & ( (\inst5|filter\(5) & (\inst5|filter\(7) & 
-- \inst5|filter\(6))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000010111011111111111111101111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \inst5|ALT_INV_Equal1~0_combout\,
...
-- Equation(s):
-- \inst5|OUTCNT~2_combout\ = ( \inst5|OUTCNT\(2) & ( (!\inst5|OUTCNT\(3) & (!\inst5|OUTCNT\(0) $ (!\inst5|OUTCNT\(1)))) ) ) # ( !\inst5|OUTCNT\(2) & ( (!\inst5|OUTCNT\(0) & (\inst5|OUTCNT\(1) & !\inst5|OUTCNT\(3))) # (\inst5|OUTCNT\(0) & 
-- (!\inst5|OUTCNT\(1))) ) )
...
-- Equation(s):
-- \inst5|Selector3~0_combout\ = ( \inst5|mouse_state.LOAD_COMMAND2~q\ ) # ( !\inst5|mouse_state.LOAD_COMMAND2~q\ & ( (!\inst5|output_ready~q\ & \inst5|mouse_state.WAIT_OUTPUT_READY~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101000001010111111111111111100001010000010101111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011011000110110001101100011011000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|READ_CHAR~0_combout\ = ( \PS2_DAT~input_o\ & ( \inst5|INCNT\(2) & ( (\inst5|READ_CHAR~q\ & !\inst5|INCNT\(3)) ) ) ) # ( !\PS2_DAT~input_o\ & ( \inst5|INCNT\(2) & ( (!\inst5|READ_CHAR~q\) # (!\inst5|INCNT\(3)) ) ) ) # ( \PS2_DAT~input_o\ & ( 
-- !\inst5|INCNT\(2) & ( (\inst5|READ_CHAR~q\ & ((!\inst5|INCNT\(3)) # ((!\inst5|INCNT\(0) & !\inst5|INCNT\(1))))) ) ) ) # ( !\PS2_DAT~input_o\ & ( !\inst5|INCNT\(2) & ( (!\inst5|READ_CHAR~q\) # ((!\inst5|INCNT\(3)) # ((!\inst5|INCNT\(0) & 
-- !\inst5|INCNT\(1)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111101100001100110010000011111111110011000011001100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_INCNT\(0),
...
-- Equation(s):
-- \inst5|mouse_state.INPUT_PACKETS~0_combout\ = ( \inst5|mouse_state.INPUT_PACKETS~q\ ) # ( !\inst5|mouse_state.INPUT_PACKETS~q\ & ( (\inst5|iready_set~q\ & \inst5|mouse_state.WAIT_CMD_ACK~q\) ) )
...
-- Equation(s):
-- \inst5|Selector6~0_combout\ = ( \inst5|mouse_state.LOAD_COMMAND~q\ & ( \inst5|mouse_state.INHIBIT_TRANS~q\ ) ) # ( !\inst5|mouse_state.LOAD_COMMAND~q\ & ( \inst5|mouse_state.INHIBIT_TRANS~q\ & ( ((\inst5|mouse_state.INPUT_PACKETS~q\ & 
-- \inst5|send_data~q\)) # (\inst5|mouse_state.LOAD_COMMAND2~q\) ) ) ) # ( \inst5|mouse_state.LOAD_COMMAND~q\ & ( !\inst5|mouse_state.INHIBIT_TRANS~q\ ) ) # ( !\inst5|mouse_state.LOAD_COMMAND~q\ & ( !\inst5|mouse_state.INHIBIT_TRANS~q\ & ( 
-- (\inst5|send_data~q\) # (\inst5|mouse_state.LOAD_COMMAND2~q\) ) ) )
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = ( \inst2|h_count\(3) & ( !\inst2|h_count\(6) & ( (\inst2|h_count\(9) & (\inst2|h_count\(0) & (\inst2|h_count[4]~DUPLICATE_q\ & \inst2|h_count\(1)))) ) ) )
...
-- Equation(s):
-- \inst2|Equal0~1_combout\ = ( \inst2|h_count\(2) & ( (!\inst2|h_count\(7) & (\inst2|h_count\(8) & (\inst2|Equal0~0_combout\ & !\inst2|h_count\(5)))) ) )
...
PORT MAP (
	...
	datad => \inst2|ALT_INV_h_count\(0),
	datae => \inst2|ALT_INV_h_count[2]~DUPLICATE_q\,
...
-- Location: LABCELL_X10_Y14_N48
\inst2|process_0~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst2|process_0~4_combout\ = ( \inst2|h_count[4]~DUPLICATE_q\ & ( !\inst2|h_count[6]~DUPLICATE_q\ & ( (!\inst2|h_count\(3)) # ((!\inst2|h_count\(5)) # (\inst2|LessThan1~0_combout\)) ) ) ) # ( !\inst2|h_count[4]~DUPLICATE_q\ & ( 
-- !\inst2|h_count[6]~DUPLICATE_q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111001111111100000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst2|Equal1~0_combout\ = ( !\inst2|h_count[2]~DUPLICATE_q\ & ( (\inst2|h_count\(7) & (!\inst2|h_count\(8) & (\inst2|h_count\(5) & \inst2|Equal0~0_combout\))) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000101010001000100010101000111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst2|process_0~6_combout\ = ( \inst2|process_0~5_combout\ & ( (\inst2|v_count\(2) & (\inst2|v_count\(3) & (\inst2|h_count\(9) & \inst2|v_count\(9)))) ) ) # ( !\inst2|process_0~5_combout\ & ( (\inst2|h_count\(9) & \inst2|v_count\(9)) ) )
...
-- Equation(s):
-- \inst2|process_0~0_combout\ = ( \inst2|v_count\(0) & ( (!\inst2|v_count\(4) & (!\inst2|v_count\(1) & !\inst2|v_count\(9))) ) ) # ( !\inst2|v_count\(0) & ( (!\inst2|v_count\(4) & (\inst2|v_count\(1) & !\inst2|v_count\(9))) ) )
...
-- Equation(s):
-- \inst2|process_0~1_combout\ = (!\inst2|v_count\(2)) # ((!\inst2|v_count\(3)) # ((!\inst2|process_0~0_combout\) # (!\inst2|LessThan7~0_combout\)))
...
-- Location: MLABCELL_X9_Y14_N51
\inst2|process_0~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst2|process_0~2_combout\ = ( \inst2|h_count[4]~DUPLICATE_q\ & ( (!\inst2|h_count\(3) & (!\inst2|h_count\(2) & ((!\inst2|h_count\(0)) # (!\inst2|h_count\(1))))) ) ) # ( !\inst2|h_count[4]~DUPLICATE_q\ )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111111111111110100000100000001010000010000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
\inst5|new_cursor_column[7]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst5|new_cursor_column[7]~0_combout\ = ( \inst5|PACKET_COUNT\(0) & ( !\inst5|PACKET_COUNT\(1) ) ) # ( !\inst5|PACKET_COUNT\(0) & ( \inst5|PACKET_COUNT\(1) ) )
...
PORT MAP (
	...
	combout => \inst5|new_cursor_column[7]~0_combout\);
...
PORT MAP (
	clk => \inst5|ALT_INV_MOUSE_CLK_FILTER~q\,
	asdata => \inst5|new_cursor_column[7]~0_combout\,
	sload => VCC,
...
-- Equation(s):
-- \inst5|new_cursor_row[9]~0_combout\ = ( !\inst5|new_cursor_column[7]~0_combout\ & ( (\inst5|READ_CHAR~q\ & (\inst5|LessThan1~0_combout\ & !\inst5|mouse_state.WAIT_OUTPUT_READY~q\)) ) )
...
PORT MAP (
	...
	datad => \inst5|ALT_INV_mouse_state.WAIT_OUTPUT_READY~q\,
	dataf => \inst5|ALT_INV_new_cursor_column[7]~0_combout\,
...
-- Equation(s):
-- \inst5|cursor_row~10_combout\ = ( \inst5|LessThan5~3_combout\ & ( \inst5|new_cursor_row\(1) & ( (!\inst5|Equal3~0_combout\ & (((\inst5|cursor_row\(7)) # (\inst5|RECV_UART~1_combout\)) # (\inst5|cursor_row\(8)))) ) ) )
...
-- Equation(s):
-- \inst5|PACKET_CHAR1[1]~0_combout\ = ( \inst5|LessThan1~0_combout\ & ( (!\inst5|PACKET_COUNT\(1) & (!\inst5|mouse_state.WAIT_OUTPUT_READY~q\ & \inst5|READ_CHAR~q\)) ) )
...
-- Equation(s):
-- \inst5|cursor_row~9_combout\ = ( \inst5|LessThan5~3_combout\ & ( \inst5|new_cursor_row\(2) & ( (!\inst5|Equal3~0_combout\ & (((\inst5|cursor_row\(7)) # (\inst5|RECV_UART~1_combout\)) # (\inst5|cursor_row\(8)))) ) ) )
...
-- Equation(s):
-- \inst5|cursor_row~8_combout\ = ( \inst5|LessThan5~3_combout\ & ( \inst5|new_cursor_row\(3) & ( (!\inst5|Equal3~0_combout\ & (((\inst5|cursor_row\(7)) # (\inst5|RECV_UART~1_combout\)) # (\inst5|cursor_row\(8)))) ) ) )
...
-- Equation(s):
-- \inst5|LessThan5~2_combout\ = ( \inst5|new_cursor_row\(5) & ( (\inst5|new_cursor_row\(6) & \inst5|new_cursor_row\(7)) ) )
...
-- Equation(s):
-- \inst5|LessThan5~1_combout\ = ( !\inst5|new_cursor_row\(2) & ( (!\inst5|new_cursor_row\(1) & (!\inst5|new_cursor_row\(4) & (!\inst5|new_cursor_row\(3) & !\inst5|new_cursor_row\(0)))) ) )
...
-- Equation(s):
-- \inst5|cursor_row~6_combout\ = ( \inst5|LessThan5~1_combout\ & ( (!\inst5|new_cursor_row\(9) & \inst5|new_cursor_row\(4)) ) ) # ( !\inst5|LessThan5~1_combout\ & ( (!\inst5|new_cursor_row\(9) & (\inst5|new_cursor_row\(4) & ((!\inst5|LessThan5~2_combout\) # 
-- (!\inst5|new_cursor_row\(8))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010101000000000001010100000000000101010100000000010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|cursor_row~7_combout\ = ( \inst5|RECV_UART~1_combout\ & ( \inst5|PACKET_COUNT\(1) & ( \inst5|cursor_row~6_combout\ ) ) ) # ( !\inst5|RECV_UART~1_combout\ & ( \inst5|PACKET_COUNT\(1) & ( (\inst5|cursor_row~6_combout\ & ((\inst5|cursor_row\(7)) # 
-- (\inst5|cursor_row\(8)))) ) ) ) # ( \inst5|RECV_UART~1_combout\ & ( !\inst5|PACKET_COUNT\(1) & ( (!\inst5|PACKET_COUNT\(0)) # (\inst5|cursor_row~6_combout\) ) ) ) # ( !\inst5|RECV_UART~1_combout\ & ( !\inst5|PACKET_COUNT\(1) & ( (!\inst5|PACKET_COUNT\(0)) 
-- # ((\inst5|cursor_row~6_combout\ & ((\inst5|cursor_row\(7)) # (\inst5|cursor_row\(8))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110111001111110011111100111100000101000011110000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_row\(8),
...
-- Equation(s):
-- \inst5|cursor_row~13_combout\ = ( \inst5|LessThan5~3_combout\ & ( \inst5|new_cursor_row\(0) & ( (!\inst5|Equal3~0_combout\ & (((\inst5|cursor_row\(7)) # (\inst5|RECV_UART~1_combout\)) # (\inst5|cursor_row\(8)))) ) ) )
...
-- Equation(s):
-- \inst5|LessThan5~0_combout\ = ( !\inst5|new_cursor_row\(3) & ( (!\inst5|new_cursor_row\(4) & (!\inst5|new_cursor_row\(1) & !\inst5|new_cursor_row\(2))) ) )
...
-- Equation(s):
-- \inst5|RECV_UART~1_combout\ = ( \inst5|new_cursor_row\(8) & ( (!\inst5|new_cursor_row\(0) & (!\inst5|new_cursor_row\(9) & (\inst5|LessThan5~0_combout\ & \inst5|RECV_UART~0_combout\))) ) ) # ( !\inst5|new_cursor_row\(8) & ( (!\inst5|new_cursor_row\(9) & 
-- ((!\inst5|LessThan5~0_combout\) # (!\inst5|RECV_UART~0_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011000000110011001100000000000000000010000000000000001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|cursor_row~11_combout\ = (!\inst5|new_cursor_row\(9) & !\inst5|new_cursor_row\(5))
...
-- Equation(s):
-- \inst5|cursor_row~3_combout\ = ( \inst5|cursor_row~2_combout\ & ( \inst5|RECV_UART~1_combout\ & ( (!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0)) ) ) ) # ( !\inst5|cursor_row~2_combout\ & ( \inst5|RECV_UART~1_combout\ ) ) # ( 
-- \inst5|cursor_row~2_combout\ & ( !\inst5|RECV_UART~1_combout\ & ( (!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0)) ) ) ) # ( !\inst5|cursor_row~2_combout\ & ( !\inst5|RECV_UART~1_combout\ & ( (((!\inst5|PACKET_COUNT\(1) & !\inst5|PACKET_COUNT\(0))) # 
-- (\inst5|cursor_row\(7))) # (\inst5|cursor_row\(8)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1101111101011111110011000000000011111111111111111100110000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_row\(8),
...
-- Equation(s):
-- \inst5|cursor_row~1_combout\ = ( \inst5|cursor_row\(7) & ( \inst5|RECV_UART~1_combout\ & ( (!\inst5|cursor_row~0_combout\ & ((\inst5|PACKET_COUNT\(1)) # (\inst5|PACKET_COUNT\(0)))) ) ) ) # ( !\inst5|cursor_row\(7) & ( \inst5|RECV_UART~1_combout\ & ( 
-- (!\inst5|cursor_row~0_combout\ & ((\inst5|PACKET_COUNT\(1)) # (\inst5|PACKET_COUNT\(0)))) ) ) ) # ( \inst5|cursor_row\(7) & ( !\inst5|RECV_UART~1_combout\ & ( (!\inst5|cursor_row~0_combout\ & ((\inst5|PACKET_COUNT\(1)) # (\inst5|PACKET_COUNT\(0)))) ) ) ) 
-- # ( !\inst5|cursor_row\(7) & ( !\inst5|RECV_UART~1_combout\ & ( (!\inst5|cursor_row~0_combout\ & (\inst5|cursor_row\(8) & ((\inst5|PACKET_COUNT\(1)) # (\inst5|PACKET_COUNT\(0))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010000001100010001001100110001000100110011000100010011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_PACKET_COUNT\(0),
	datab => \inst5|ALT_INV_cursor_row~0_combout\,
...
-- Equation(s):
-- \inst5|cursor_row~5_combout\ = ( \inst5|RECV_UART~1_combout\ & ( \inst5|cursor_row~4_combout\ & ( (!\inst5|PACKET_COUNT\(0) & !\inst5|PACKET_COUNT\(1)) ) ) ) # ( !\inst5|RECV_UART~1_combout\ & ( \inst5|cursor_row~4_combout\ & ( (!\inst5|PACKET_COUNT\(0) & 
-- !\inst5|PACKET_COUNT\(1)) ) ) ) # ( \inst5|RECV_UART~1_combout\ & ( !\inst5|cursor_row~4_combout\ ) ) # ( !\inst5|RECV_UART~1_combout\ & ( !\inst5|cursor_row~4_combout\ & ( (((!\inst5|PACKET_COUNT\(0) & !\inst5|PACKET_COUNT\(1))) # 
-- (\inst5|cursor_row\(7))) # (\inst5|cursor_row\(8)) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111000000001111111111111111101010101111111110101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst6|SevenSeg_out[5]~1_combout\ = ( \inst5|cursor_row\(7) & ( (!\inst5|cursor_row\(8)) # (\inst5|cursor_row\(6)) ) ) # ( !\inst5|cursor_row\(7) & ( (!\inst5|cursor_row\(8) & \inst5|cursor_row\(6)) ) )
...
-- Equation(s):
-- \inst6|SevenSeg_out[4]~2_combout\ = ( \inst5|cursor_row\(6) ) # ( !\inst5|cursor_row\(6) & ( (!\inst5|cursor_row\(7) & \inst5|cursor_row\(8)) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101101001011010010110100101101000000101000001010000010100000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_row\(8),
...
-- Equation(s):
-- \inst5|PACKET_CHAR2[7]~1_combout\ = ( \inst5|LessThan1~0_combout\ & ( (\inst5|READ_CHAR~q\ & (\inst5|PACKET_COUNT\(1) & (!\inst5|PACKET_COUNT\(0) & !\inst5|mouse_state.WAIT_OUTPUT_READY~q\))) ) )
...
-- Equation(s):
-- \inst5|cursor_column~4_combout\ = ( \inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(0) & !\inst5|new_cursor_column\(9)) ) ) # ( !\inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(0) & ((!\inst5|new_cursor_column\(7)) # 
...
-- Equation(s):
-- \inst5|cursor_column[5]~1_combout\ = ( !\inst5|PACKET_COUNT\(1) & ( \inst5|RECV_UART~3_combout\ & ( !\inst5|PACKET_COUNT\(0) ) ) ) # ( \inst5|PACKET_COUNT\(1) & ( !\inst5|RECV_UART~3_combout\ & ( (!\inst5|cursor_column\(8) & (!\inst5|cursor_column\(9) & 
-- !\inst5|cursor_column\(7))) ) ) ) # ( !\inst5|PACKET_COUNT\(1) & ( !\inst5|RECV_UART~3_combout\ & ( (!\inst5|PACKET_COUNT\(0)) # ((!\inst5|cursor_column\(8) & (!\inst5|cursor_column\(9) & !\inst5|cursor_column\(7)))) ) ) )
...
-- Equation(s):
-- \inst5|cursor_column~9_combout\ = ( \inst5|new_cursor_column\(7) & ( \inst5|RECV_UART~2_combout\ & ( (\inst5|new_cursor_column\(1) & ((!\inst5|new_cursor_column\(9)) # ((!\inst5|new_cursor_column\(8) & !\inst5|new_cursor_column\(0))))) ) ) ) # ( 
-- !\inst5|new_cursor_column\(7) & ( \inst5|RECV_UART~2_combout\ & ( (\inst5|new_cursor_column\(1) & ((!\inst5|new_cursor_column\(8)) # (!\inst5|new_cursor_column\(9)))) ) ) ) # ( \inst5|new_cursor_column\(7) & ( !\inst5|RECV_UART~2_combout\ & ( 
-- (!\inst5|new_cursor_column\(9) & \inst5|new_cursor_column\(1)) ) ) ) # ( !\inst5|new_cursor_column\(7) & ( !\inst5|RECV_UART~2_combout\ & ( (\inst5|new_cursor_column\(1) & ((!\inst5|new_cursor_column\(8)) # (!\inst5|new_cursor_column\(9)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111000001110000011000000110000001110000011100000111000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \inst5|ALT_INV_new_cursor_column\(0),
	datae => \inst5|ALT_INV_new_cursor_column\(7),
...
-- Equation(s):
-- \inst5|cursor_column~6_combout\ = ( \inst5|RECV_UART~2_combout\ & ( \inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(4) & !\inst5|new_cursor_column\(9)) ) ) ) # ( !\inst5|RECV_UART~2_combout\ & ( \inst5|new_cursor_column\(8) & ( 
-- (\inst5|new_cursor_column\(4) & !\inst5|new_cursor_column\(9)) ) ) ) # ( \inst5|RECV_UART~2_combout\ & ( !\inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(4) & ((!\inst5|new_cursor_column\(7)) # ((!\inst5|new_cursor_column\(0)) # 
-- (!\inst5|new_cursor_column\(9))))) ) ) ) # ( !\inst5|RECV_UART~2_combout\ & ( !\inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(4) & ((!\inst5|new_cursor_column\(7)) # (!\inst5|new_cursor_column\(9)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_new_cursor_column\(4),
	datab => \inst5|ALT_INV_new_cursor_column\(7),
	datac => \inst5|ALT_INV_new_cursor_column\(0),
	datad => \inst5|ALT_INV_new_cursor_column\(9),
	datae => \inst5|ALT_INV_RECV_UART~2_combout\,
...
-- Equation(s):
-- \inst5|cursor_column~5_combout\ = ( \inst5|RECV_UART~2_combout\ & ( \inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(5) & !\inst5|new_cursor_column\(9)) ) ) ) # ( !\inst5|RECV_UART~2_combout\ & ( \inst5|new_cursor_column\(8) & ( 
-- (\inst5|new_cursor_column\(5) & !\inst5|new_cursor_column\(9)) ) ) ) # ( \inst5|RECV_UART~2_combout\ & ( !\inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(5) & ((!\inst5|new_cursor_column\(7)) # ((!\inst5|new_cursor_column\(0)) # 
-- (!\inst5|new_cursor_column\(9))))) ) ) ) # ( !\inst5|RECV_UART~2_combout\ & ( !\inst5|new_cursor_column\(8) & ( (\inst5|new_cursor_column\(5) & ((!\inst5|new_cursor_column\(7)) # (!\inst5|new_cursor_column\(9)))) ) ) )
...
-- Equation(s):
-- \inst5|RECV_UART~2_combout\ = ( !\inst5|new_cursor_column\(1) & ( !\inst5|new_cursor_column\(5) & ( (!\inst5|new_cursor_column\(2) & (!\inst5|new_cursor_column\(3) & (!\inst5|new_cursor_column\(6) & !\inst5|new_cursor_column\(4)))) ) ) )
...
-- Equation(s):
-- \inst5|LessThan9~0_combout\ = ( \inst5|new_cursor_column\(9) & ( \inst5|RECV_UART~2_combout\ & ( ((\inst5|new_cursor_column\(0) & \inst5|new_cursor_column\(7))) # (\inst5|new_cursor_column\(8)) ) ) ) # ( \inst5|new_cursor_column\(9) & ( 
-- !\inst5|RECV_UART~2_combout\ & ( (\inst5|new_cursor_column\(7)) # (\inst5|new_cursor_column\(8)) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001111000011110000111111011111000011111101111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst5|RECV_UART~3_combout\ = ( \inst5|new_cursor_column\(0) & ( \inst5|RECV_UART~2_combout\ & ( (\inst5|new_cursor_column\(7) & (!\inst5|new_cursor_column\(8) & !\inst5|new_cursor_column\(9))) ) ) ) # ( !\inst5|new_cursor_column\(0) & ( 
-- \inst5|RECV_UART~2_combout\ & ( (!\inst5|new_cursor_column\(9) & (!\inst5|new_cursor_column\(7) $ (!\inst5|new_cursor_column\(8)))) ) ) ) # ( \inst5|new_cursor_column\(0) & ( !\inst5|RECV_UART~2_combout\ & ( (!\inst5|new_cursor_column\(8) & 
-- !\inst5|new_cursor_column\(9)) ) ) ) # ( !\inst5|new_cursor_column\(0) & ( !\inst5|RECV_UART~2_combout\ & ( (!\inst5|new_cursor_column\(8) & !\inst5|new_cursor_column\(9)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111000000000000111100000000000001011010000000000101000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_new_cursor_column\(7),
...
-- Equation(s):
-- \inst7|SevenSeg_out[6]~0_combout\ = ( \inst5|cursor_column\(7) & ( ((\inst5|cursor_column\(6) & \inst5|cursor_column\(8))) # (\inst5|cursor_column\(9)) ) ) # ( !\inst5|cursor_column\(7) & ( !\inst5|cursor_column\(9) $ (\inst5|cursor_column\(8)) ) )
...
-- Equation(s):
-- \inst7|SevenSeg_out[5]~6_combout\ = ( \inst5|cursor_column\(8) & ( ((\inst5|cursor_column\(7) & \inst5|cursor_column\(6))) # (\inst5|cursor_column\(9)) ) ) # ( !\inst5|cursor_column\(8) & ( ((!\inst5|cursor_column\(9) & \inst5|cursor_column\(6))) # 
...
-- Equation(s):
-- \inst7|SevenSeg_out[4]~1_combout\ = ( \inst5|cursor_column\(6) ) # ( !\inst5|cursor_column\(6) & ( (!\inst5|cursor_column\(7) & (\inst5|cursor_column\(8))) # (\inst5|cursor_column\(7) & ((\inst5|cursor_column\(9)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000001011111111111111111111101010000010111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_column\(8),
...
-- Equation(s):
-- \inst7|SevenSeg_out[3]~5_combout\ = ( \inst5|cursor_column\(7) & ( \inst5|cursor_column\(8) & ( (\inst5|cursor_column\(9)) # (\inst5|cursor_column\(6)) ) ) ) # ( !\inst5|cursor_column\(7) & ( \inst5|cursor_column\(8) & ( (!\inst5|cursor_column\(6)) # 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100010001000100001100110011001110111011101110110111011101110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst7|SevenSeg_out[2]~4_combout\ = ( \inst5|cursor_column\(6) & ( \inst5|cursor_column\(8) & ( \inst5|cursor_column\(9) ) ) ) # ( !\inst5|cursor_column\(6) & ( \inst5|cursor_column\(8) & ( \inst5|cursor_column\(9) ) ) ) # ( \inst5|cursor_column\(6) & ( 
-- !\inst5|cursor_column\(8) & ( (\inst5|cursor_column\(7) & \inst5|cursor_column\(9)) ) ) ) # ( !\inst5|cursor_column\(6) & ( !\inst5|cursor_column\(8) & ( \inst5|cursor_column\(7) ) ) )
...
-- Equation(s):
-- \inst7|SevenSeg_out[1]~3_combout\ = ( \inst5|cursor_column\(8) & ( (!\inst5|cursor_column\(9) & (!\inst5|cursor_column\(7) $ (\inst5|cursor_column\(6)))) ) ) # ( !\inst5|cursor_column\(8) & ( (!\inst5|cursor_column\(7)) # (!\inst5|cursor_column\(9)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1110111011101110111011101110111010001000010001001000100001000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_column\(7),
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101010100000000010101010000001011111010111110101111101011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst5|ALT_INV_cursor_column\(7),
...
-- Equation(s):
-- \inst5|PACKET_CHAR1[1]~1_combout\ = ( !\inst5|mouse_state.WAIT_OUTPUT_READY~q\ & ( !\inst5|PACKET_COUNT\(1) & ( (\inst5|READ_CHAR~q\ & (\inst5|PACKET_COUNT\(0) & \inst5|LessThan1~0_combout\)) ) ) )
...
-- Equation(s):
-- \inst3|Add7~1_sumout\ = SUM(( \inst3|ball_y_motion\(3) ) + ( \inst3|ball_y_pos\(8) ) + ( \inst3|Add7~30\ ))
-- \inst3|Add7~2\ = CARRY(( \inst3|ball_y_motion\(3) ) + ( \inst3|ball_y_pos\(8) ) + ( \inst3|Add7~30\ ))
...
-- Equation(s):
-- \inst3|Add7~37_sumout\ = SUM(( \inst3|ball_y_pos\(9) ) + ( \inst3|ball_y_motion\(3) ) + ( \inst3|Add7~2\ ))
...
-- Equation(s):
-- \inst3|LessThan5~0_combout\ = ( !\inst3|ball_y_pos\(3) & ( \inst3|ball_y_pos\(0) & ( (!\inst3|ball_y_pos\(4) & (!\inst3|ball_y_pos\(5) & ((!\inst3|ball_y_pos\(2)) # (!\inst3|ball_y_pos[1]~DUPLICATE_q\)))) ) ) ) # ( !\inst3|ball_y_pos\(3) & ( 
-- !\inst3|ball_y_pos\(0) & ( (!\inst3|ball_y_pos\(4) & !\inst3|ball_y_pos\(5)) ) ) )
...
-- Equation(s):
-- \inst3|LessThan4~1_combout\ = ( !\inst3|ball_y_pos\(6) & ( !\inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(8) & !\inst3|ball_y_pos\(5)) ) ) )
...
-- Equation(s):
-- \inst3|ball_y_motion~2_combout\ = ( \inst3|LessThan5~0_combout\ & ( \inst3|LessThan4~1_combout\ & ( (!\inst3|ball_y_pos\(9) & ((!\inst5|left_button~q\) # (\inst3|LessThan4~0_combout\))) ) ) ) # ( !\inst3|LessThan5~0_combout\ & ( 
-- \inst3|LessThan4~1_combout\ & ( (!\inst3|ball_y_pos\(9) & ((!\inst5|left_button~q\ & ((!\inst3|LessThan5~1_combout\))) # (\inst5|left_button~q\ & (\inst3|LessThan4~0_combout\)))) ) ) ) # ( \inst3|LessThan5~0_combout\ & ( !\inst3|LessThan4~1_combout\ & ( 
-- !\inst3|ball_y_pos\(9) ) ) ) # ( !\inst3|LessThan5~0_combout\ & ( !\inst3|LessThan4~1_combout\ & ( (!\inst3|ball_y_pos\(9) & ((!\inst3|LessThan5~1_combout\) # (\inst5|left_button~q\))) ) ) )
...
-- Equation(s):
-- \inst3|Add7~9_sumout\ = SUM(( \inst3|ball_y_pos[2]~DUPLICATE_q\ ) + ( \inst3|ball_y_motion\(1) ) + ( \inst3|Add7~14\ ))
-- \inst3|Add7~10\ = CARRY(( \inst3|ball_y_pos[2]~DUPLICATE_q\ ) + ( \inst3|ball_y_motion\(1) ) + ( \inst3|Add7~14\ ))
...
PORT MAP (
	...
	datac => \inst3|ALT_INV_ball_y_pos[2]~DUPLICATE_q\,
	cin => \inst3|Add7~14\,
...
-- Equation(s):
-- \inst3|LessThan5~1_combout\ = ( \inst3|ball_y_pos\(8) & ( (\inst3|ball_y_pos\(6) & \inst3|ball_y_pos\(7)) ) )
...
-- Equation(s):
-- \inst3|LessThan4~0_combout\ = ( \inst3|ball_y_pos[0]~DUPLICATE_q\ & ( (\inst3|ball_y_pos\(3) & \inst3|ball_y_pos\(4)) ) ) # ( !\inst3|ball_y_pos[0]~DUPLICATE_q\ & ( (\inst3|ball_y_pos\(3) & (\inst3|ball_y_pos\(4) & ((\inst3|ball_y_pos[2]~DUPLICATE_q\) # 
-- (\inst3|ball_y_pos[1]~DUPLICATE_q\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000010101000000000101010100000000000101010000000001010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(3),
...
-- Equation(s):
-- \inst3|ball_y_motion~0_combout\ = ( \inst3|LessThan4~1_combout\ & ( (\inst3|LessThan4~0_combout\ & (\inst5|left_button~q\ & !\inst3|ball_y_pos\(9))) ) ) # ( !\inst3|LessThan4~1_combout\ & ( (\inst5|left_button~q\ & !\inst3|ball_y_pos\(9)) ) )
...
-- Equation(s):
-- \inst2|LessThan7~1_combout\ = ( \inst2|v_count\(5) & ( (!\inst2|v_count\(9) & ((!\inst2|v_count\(6)) # ((!\inst2|v_count\(7)) # (!\inst2|v_count\(8))))) ) ) # ( !\inst2|v_count\(5) & ( !\inst2|v_count\(9) ) )
...
-- Equation(s):
-- \inst3|LessThan3~0_combout\ = ( \inst2|pixel_row\(1) & ( (!\inst3|ball_y_pos[1]~DUPLICATE_q\) # ((!\inst3|ball_y_pos\(0) & \inst2|pixel_row\(0))) ) ) # ( !\inst2|pixel_row\(1) & ( (!\inst3|ball_y_pos\(0) & (!\inst3|ball_y_pos[1]~DUPLICATE_q\ & 
-- \inst2|pixel_row\(0))) ) )
...
-- Equation(s):
-- \inst3|LessThan3~1_combout\ = ( \inst3|LessThan3~0_combout\ & ( (!\inst3|ball_y_pos\(3) & ((!\inst3|ball_y_pos[2]~DUPLICATE_q\) # ((\inst2|pixel_row\(2)) # (\inst2|pixel_row\(3))))) # (\inst3|ball_y_pos\(3) & (\inst2|pixel_row\(3) & 
-- ((!\inst3|ball_y_pos[2]~DUPLICATE_q\) # (\inst2|pixel_row\(2))))) ) ) # ( !\inst3|LessThan3~0_combout\ & ( (!\inst3|ball_y_pos\(3) & (((!\inst3|ball_y_pos[2]~DUPLICATE_q\ & \inst2|pixel_row\(2))) # (\inst2|pixel_row\(3)))) # (\inst3|ball_y_pos\(3) & 
-- (!\inst3|ball_y_pos[2]~DUPLICATE_q\ & (\inst2|pixel_row\(3) & \inst2|pixel_row\(2)))) ) )
...
-- Equation(s):
-- \inst2|pixel_row[4]~feeder_combout\ = ( \inst2|v_count\(4) )
...
-- Equation(s):
-- \inst3|LessThan3~2_combout\ = ( \inst3|ball_y_pos\(5) & ( \inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(6) & (\inst2|pixel_row\(7) & (!\inst3|ball_y_pos\(4) $ (\inst2|pixel_row\(6))))) # (\inst3|ball_y_pos\(6) & ((!\inst3|ball_y_pos\(4) & 
-- (\inst2|pixel_row\(6) & \inst2|pixel_row\(7))) # (\inst3|ball_y_pos\(4) & (!\inst2|pixel_row\(6) & !\inst2|pixel_row\(7))))) ) ) ) # ( !\inst3|ball_y_pos\(5) & ( \inst3|ball_y_pos\(7) & ( (\inst2|pixel_row\(7) & (!\inst3|ball_y_pos\(6) $ 
-- (\inst2|pixel_row\(6)))) ) ) ) # ( \inst3|ball_y_pos\(5) & ( !\inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(6) & (!\inst2|pixel_row\(7) & (!\inst3|ball_y_pos\(4) $ (\inst2|pixel_row\(6))))) # (\inst3|ball_y_pos\(6) & ((!\inst3|ball_y_pos\(4) & 
-- (\inst2|pixel_row\(6) & !\inst2|pixel_row\(7))) # (\inst3|ball_y_pos\(4) & (!\inst2|pixel_row\(6) & \inst2|pixel_row\(7))))) ) ) ) # ( !\inst3|ball_y_pos\(5) & ( !\inst3|ball_y_pos\(7) & ( (!\inst2|pixel_row\(7) & (!\inst3|ball_y_pos\(6) $ 
-- (\inst2|pixel_row\(6)))) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010010100000000100001100001000000000000101001010001000010000110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(6),
...
-- Equation(s):
-- \inst3|LessThan3~3_combout\ = ( \inst3|LessThan3~2_combout\ & ( (!\inst2|pixel_row[4]~DUPLICATE_q\ & (\inst3|ball_y_pos\(4) & (!\inst2|pixel_row\(5) $ (!\inst3|ball_y_pos\(5))))) # (\inst2|pixel_row[4]~DUPLICATE_q\ & (!\inst3|ball_y_pos\(4) & 
-- (!\inst2|pixel_row\(5) $ (\inst3|ball_y_pos\(5))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000001000010000110000100001000011000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|LessThan3~4_combout\ = ( \inst3|ball_y_pos\(6) & ( \inst3|ball_y_pos\(7) & ( (\inst3|ball_y_pos\(5) & (\inst3|ball_y_pos\(4) & ((\inst2|pixel_row\(6)) # (\inst2|pixel_row\(7))))) ) ) ) # ( !\inst3|ball_y_pos\(6) & ( \inst3|ball_y_pos\(7) & ( 
-- (\inst2|pixel_row\(7) & (\inst2|pixel_row\(6) & ((!\inst3|ball_y_pos\(5)) # (!\inst3|ball_y_pos\(4))))) ) ) ) # ( \inst3|ball_y_pos\(6) & ( !\inst3|ball_y_pos\(7) & ( (\inst2|pixel_row\(7) & ((!\inst3|ball_y_pos\(5)) # ((!\inst3|ball_y_pos\(4)) # 
-- (\inst2|pixel_row\(6))))) ) ) ) # ( !\inst3|ball_y_pos\(6) & ( !\inst3|ball_y_pos\(7) & ( ((\inst2|pixel_row\(6) & ((!\inst3|ball_y_pos\(5)) # (!\inst3|ball_y_pos\(4))))) # (\inst2|pixel_row\(7)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111111101111000011100000111100000000000011100000000100010001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(5),
...
-- Equation(s):
-- \inst3|LessThan3~5_combout\ = ( \inst3|ball_y_pos\(5) & ( \inst3|LessThan3~2_combout\ & ( (!\inst3|LessThan3~4_combout\ & ((!\inst3|ball_y_pos\(4)) # ((!\inst2|pixel_row[4]~DUPLICATE_q\ & !\inst2|pixel_row\(5))))) ) ) ) # ( !\inst3|ball_y_pos\(5) & ( 
-- \inst3|LessThan3~2_combout\ & ( (!\inst3|LessThan3~4_combout\ & ((!\inst2|pixel_row\(5)) # ((\inst3|ball_y_pos\(4) & !\inst2|pixel_row[4]~DUPLICATE_q\)))) ) ) ) # ( \inst3|ball_y_pos\(5) & ( !\inst3|LessThan3~2_combout\ & ( !\inst3|LessThan3~4_combout\ ) 
-- ) ) # ( !\inst3|ball_y_pos\(5) & ( !\inst3|LessThan3~2_combout\ & ( !\inst3|LessThan3~4_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011001100110011001100110011001100010000001100100010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Location: LABCELL_X12_Y14_N21
\inst3|LessThan3~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst3|LessThan3~6_combout\ = ( \inst3|Add3~0_combout\ & ( (\inst2|pixel_row\(8) & ((!\inst3|LessThan3~5_combout\) # ((\inst3|LessThan3~1_combout\ & \inst3|LessThan3~3_combout\)))) ) ) # ( !\inst3|Add3~0_combout\ & ( (!\inst2|pixel_row\(8) & 
-- ((!\inst3|LessThan3~5_combout\) # ((\inst3|LessThan3~1_combout\ & \inst3|LessThan3~3_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111000100000000111100010000000000000000111100010000000011110001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|red~0_combout\ = ( \inst2|pixel_column\(0) & ( \inst2|pixel_column\(1) & ( (\inst2|pixel_column\(7) & (\inst2|pixel_column\(5) & ((\inst2|pixel_column[4]~DUPLICATE_q\) # (\inst2|pixel_column\(2))))) ) ) ) # ( !\inst2|pixel_column\(0) & ( 
-- \inst2|pixel_column\(1) & ( (\inst2|pixel_column[4]~DUPLICATE_q\ & (\inst2|pixel_column\(7) & \inst2|pixel_column\(5))) ) ) ) # ( \inst2|pixel_column\(0) & ( !\inst2|pixel_column\(1) & ( (\inst2|pixel_column[4]~DUPLICATE_q\ & (\inst2|pixel_column\(7) & 
-- \inst2|pixel_column\(5))) ) ) ) # ( !\inst2|pixel_column\(0) & ( !\inst2|pixel_column\(1) & ( (\inst2|pixel_column[4]~DUPLICATE_q\ & (\inst2|pixel_column\(7) & \inst2|pixel_column\(5))) ) ) )
...
-- Equation(s):
-- \inst3|red~2_combout\ = ( \inst2|pixel_row\(4) & ( \inst2|pixel_row\(6) & ( (!\inst2|pixel_row\(8) & (\inst3|ball_y_pos\(8) & ((!\inst2|pixel_row\(5)) # (!\inst2|pixel_row\(7))))) # (\inst2|pixel_row\(8) & (\inst2|pixel_row\(5) & 
-- ((\inst2|pixel_row\(7))))) ) ) ) # ( !\inst2|pixel_row\(4) & ( \inst2|pixel_row\(6) & ( (\inst3|ball_y_pos\(8) & !\inst2|pixel_row\(8)) ) ) ) # ( \inst2|pixel_row\(4) & ( !\inst2|pixel_row\(6) & ( (\inst3|ball_y_pos\(8) & !\inst2|pixel_row\(8)) ) ) ) # ( 
-- !\inst2|pixel_row\(4) & ( !\inst2|pixel_row\(6) & ( (\inst3|ball_y_pos\(8) & !\inst2|pixel_row\(8)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100000000001100110000000000110011000000000011001000000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|red~1_combout\ = ( \inst3|ball_y_pos\(4) & ( \inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(8) & (\inst2|pixel_row\(8) & ((!\inst3|ball_y_pos\(6)) # (!\inst3|ball_y_pos\(5))))) # (\inst3|ball_y_pos\(8) & (\inst3|ball_y_pos\(6) & 
-- ((\inst3|ball_y_pos\(5))))) ) ) ) # ( !\inst3|ball_y_pos\(4) & ( \inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(8) & \inst2|pixel_row\(8)) ) ) ) # ( \inst3|ball_y_pos\(4) & ( !\inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(8) & \inst2|pixel_row\(8)) ) ) ) 
-- # ( !\inst3|ball_y_pos\(4) & ( !\inst3|ball_y_pos\(7) & ( (!\inst3|ball_y_pos\(8) & \inst2|pixel_row\(8)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000001100000011000000110000001100000011000000110000011001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(6),
...
-- Equation(s):
-- \inst2|pixel_column[6]~feeder_combout\ = ( \inst2|h_count[6]~DUPLICATE_q\ )
...
-- Location: LABCELL_X10_Y14_N30
\inst3|LessThan0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst3|LessThan0~1_combout\ = ( !\inst2|pixel_column\(6) & ( !\inst2|pixel_column\(3) & ( (!\inst2|pixel_column\(4) & (!\inst2|pixel_column\(5) & ((!\inst2|pixel_column\(2)) # (!\inst2|pixel_column\(1))))) ) ) )
...
-- Equation(s):
-- \inst3|red~4_combout\ = ( \inst2|pixel_column\(3) & ( (!\inst2|pixel_column[7]~DUPLICATE_q\ & (\inst2|pixel_column\(6) & (\inst2|pixel_column\(5) & \inst2|pixel_column[4]~DUPLICATE_q\))) # (\inst2|pixel_column[7]~DUPLICATE_q\ & 
-- (((!\inst2|pixel_column\(5))))) ) ) # ( !\inst2|pixel_column\(3) & ( ((\inst2|pixel_column\(6) & (\inst2|pixel_column\(5) & \inst2|pixel_column[4]~DUPLICATE_q\))) # (\inst2|pixel_column[7]~DUPLICATE_q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110111001100110011011100110000001101000011000000110100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|red~3_combout\ = ( !\inst3|ball_y_pos\(9) & ( (!\inst2|pixel_column\(8) & (!\inst2|pixel_column\(9) & ((!\inst2|pixel_column\(6)) # (!\inst2|pixel_column[7]~DUPLICATE_q\)))) ) )
...
-- Equation(s):
-- \inst3|red~5_combout\ = ( \inst3|red~4_combout\ & ( \inst3|red~3_combout\ & ( (!\inst3|red~0_combout\ & (!\inst3|red~2_combout\ & (!\inst3|red~1_combout\ & !\inst3|LessThan0~1_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_red~0_combout\,
	datab => \inst3|ALT_INV_red~2_combout\,
	datac => \inst3|ALT_INV_red~1_combout\,
...
-- Equation(s):
-- \inst3|LessThan0~0_combout\ = ( \inst2|pixel_column\(6) & ( \inst2|pixel_column\(1) & ( (\inst2|pixel_column[4]~DUPLICATE_q\ & \inst2|pixel_column\(5)) ) ) ) # ( !\inst2|pixel_column\(6) & ( \inst2|pixel_column\(1) & ( (!\inst2|pixel_column\(2) & 
-- (!\inst2|pixel_column[4]~DUPLICATE_q\ & (!\inst2|pixel_column\(3) & !\inst2|pixel_column\(5)))) ) ) ) # ( \inst2|pixel_column\(6) & ( !\inst2|pixel_column\(1) & ( (\inst2|pixel_column[4]~DUPLICATE_q\ & \inst2|pixel_column\(5)) ) ) ) # ( 
-- !\inst2|pixel_column\(6) & ( !\inst2|pixel_column\(1) & ( (!\inst2|pixel_column[4]~DUPLICATE_q\ & (!\inst2|pixel_column\(3) & !\inst2|pixel_column\(5))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000000000000000000000011001110000000000000000000000000110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_pixel_column\(2),
...
-- Equation(s):
-- \inst3|LessThan2~0_combout\ = ( \inst2|pixel_row\(0) & ( (\inst3|ball_y_pos[1]~DUPLICATE_q\ & !\inst2|pixel_row\(1)) ) ) # ( !\inst2|pixel_row\(0) & ( (!\inst3|ball_y_pos[1]~DUPLICATE_q\ & (\inst3|ball_y_pos\(0) & !\inst2|pixel_row\(1))) # 
-- (\inst3|ball_y_pos[1]~DUPLICATE_q\ & ((!\inst2|pixel_row\(1)) # (\inst3|ball_y_pos\(0)))) ) )
...
-- Equation(s):
-- \inst3|LessThan2~1_combout\ = ( \inst3|LessThan2~0_combout\ & ( (!\inst3|ball_y_pos\(3) & (!\inst2|pixel_row\(3) & ((!\inst2|pixel_row\(2)) # (\inst3|ball_y_pos[2]~DUPLICATE_q\)))) # (\inst3|ball_y_pos\(3) & (((!\inst2|pixel_row\(2)) # 
-- (!\inst2|pixel_row\(3))) # (\inst3|ball_y_pos[2]~DUPLICATE_q\))) ) ) # ( !\inst3|LessThan2~0_combout\ & ( (!\inst3|ball_y_pos\(3) & (\inst3|ball_y_pos[2]~DUPLICATE_q\ & (!\inst2|pixel_row\(2) & !\inst2|pixel_row\(3)))) # (\inst3|ball_y_pos\(3) & 
-- ((!\inst2|pixel_row\(3)) # ((\inst3|ball_y_pos[2]~DUPLICATE_q\ & !\inst2|pixel_row\(2))))) ) )
...
-- Equation(s):
-- \inst3|LessThan2~4_combout\ = ( \inst3|ball_y_pos\(7) & ( \inst3|ball_y_pos\(6) & ( (!\inst2|pixel_row\(7)) # (!\inst2|pixel_row[6]~DUPLICATE_q\ $ (((\inst2|pixel_row\(4) & \inst2|pixel_row\(5))))) ) ) ) # ( !\inst3|ball_y_pos\(7) & ( 
-- \inst3|ball_y_pos\(6) & ( (!\inst2|pixel_row[6]~DUPLICATE_q\ & (!\inst2|pixel_row\(7) & ((!\inst2|pixel_row\(4)) # (!\inst2|pixel_row\(5))))) # (\inst2|pixel_row[6]~DUPLICATE_q\ & (\inst2|pixel_row\(4) & (\inst2|pixel_row\(5) & \inst2|pixel_row\(7)))) ) ) 
-- ) # ( \inst3|ball_y_pos\(7) & ( !\inst3|ball_y_pos\(6) & ( !\inst2|pixel_row\(7) $ (((\inst2|pixel_row\(4) & (\inst2|pixel_row[6]~DUPLICATE_q\ & \inst2|pixel_row\(5))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111100000000111001000000000011111111111001001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst3|LessThan2~2_combout\ = ( \inst3|ball_y_pos\(7) & ( \inst3|ball_y_pos\(6) & ( (\inst2|pixel_row\(7) & (!\inst2|pixel_row[6]~DUPLICATE_q\ $ (((!\inst2|pixel_row\(5)) # (!\inst2|pixel_row\(4)))))) ) ) ) # ( !\inst3|ball_y_pos\(7) & ( 
-- \inst3|ball_y_pos\(6) & ( (!\inst2|pixel_row\(7) & (!\inst2|pixel_row[6]~DUPLICATE_q\ $ (((!\inst2|pixel_row\(5)) # (!\inst2|pixel_row\(4)))))) ) ) ) # ( \inst3|ball_y_pos\(7) & ( !\inst3|ball_y_pos\(6) & ( (!\inst2|pixel_row\(7) & (\inst2|pixel_row\(5) & 
-- (\inst2|pixel_row[6]~DUPLICATE_q\ & \inst2|pixel_row\(4)))) # (\inst2|pixel_row\(7) & (!\inst2|pixel_row[6]~DUPLICATE_q\ & ((!\inst2|pixel_row\(5)) # (!\inst2|pixel_row\(4))))) ) ) ) # ( !\inst3|ball_y_pos\(7) & ( !\inst3|ball_y_pos\(6) & ( 
-- (!\inst2|pixel_row\(7) & (!\inst2|pixel_row[6]~DUPLICATE_q\ & ((!\inst2|pixel_row\(5)) # (!\inst2|pixel_row\(4))))) # (\inst2|pixel_row\(7) & (\inst2|pixel_row\(5) & (\inst2|pixel_row[6]~DUPLICATE_q\ & \inst2|pixel_row\(4)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000010000001001100000010010000001100010010000000001100010010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_pixel_row\(5),
...
-- Equation(s):
-- \inst3|LessThan2~5_combout\ = ( !\inst3|LessThan2~4_combout\ & ( \inst3|LessThan2~2_combout\ & ( (!\inst3|ball_y_pos\(4) & ((!\inst3|ball_y_pos\(5)) # (!\inst2|pixel_row[4]~DUPLICATE_q\ $ (!\inst2|pixel_row\(5))))) # (\inst3|ball_y_pos\(4) & 
-- ((!\inst2|pixel_row\(5) & (!\inst3|ball_y_pos\(5))) # (\inst2|pixel_row\(5) & ((!\inst2|pixel_row[4]~DUPLICATE_q\))))) ) ) ) # ( !\inst3|LessThan2~4_combout\ & ( !\inst3|LessThan2~2_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111000000000000000011001110111110000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_ball_y_pos\(4),
...
-- Equation(s):
-- \inst3|Add2~0_combout\ = ( \inst2|pixel_row[6]~DUPLICATE_q\ & ( !\inst2|pixel_row\(8) $ (((!\inst2|pixel_row[4]~DUPLICATE_q\) # ((!\inst2|pixel_row\(5)) # (!\inst2|pixel_row\(7))))) ) ) # ( !\inst2|pixel_row[6]~DUPLICATE_q\ & ( \inst2|pixel_row\(8) ) )
...
PORT MAP (
	...
	datac => \inst2|ALT_INV_pixel_row\(7),
	datad => \inst2|ALT_INV_pixel_row\(8),
	dataf => \inst2|ALT_INV_pixel_row[6]~DUPLICATE_q\,
	combout => \inst3|Add2~0_combout\);

-- Location: LABCELL_X12_Y14_N12
\inst3|LessThan2~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst3|LessThan2~3_combout\ = ( \inst3|LessThan2~2_combout\ & ( (!\inst3|ball_y_pos\(4) & (\inst2|pixel_row[4]~DUPLICATE_q\ & (!\inst3|ball_y_pos\(5) $ (!\inst2|pixel_row\(5))))) # (\inst3|ball_y_pos\(4) & (!\inst2|pixel_row[4]~DUPLICATE_q\ & 
...
-- Location: LABCELL_X12_Y14_N3
\inst3|LessThan2~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst3|LessThan2~6_combout\ = ( \inst3|ball_y_pos\(8) & ( \inst3|LessThan2~3_combout\ & ( (\inst3|Add2~0_combout\ & ((!\inst3|LessThan2~5_combout\) # (\inst3|LessThan2~1_combout\))) ) ) ) # ( !\inst3|ball_y_pos\(8) & ( \inst3|LessThan2~3_combout\ & ( 
-- (!\inst3|Add2~0_combout\ & ((!\inst3|LessThan2~5_combout\) # (\inst3|LessThan2~1_combout\))) ) ) ) # ( \inst3|ball_y_pos\(8) & ( !\inst3|LessThan2~3_combout\ & ( (!\inst3|LessThan2~5_combout\ & \inst3|Add2~0_combout\) ) ) ) # ( !\inst3|ball_y_pos\(8) & ( 
-- !\inst3|LessThan2~3_combout\ & ( (!\inst3|LessThan2~5_combout\ & !\inst3|Add2~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000000000000000001100110011011101000000000000000011011101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst2|blue_out~0_combout\ = ( \inst2|red_out~0_combout\ & ( \inst3|LessThan2~6_combout\ ) ) # ( \inst2|red_out~0_combout\ & ( !\inst3|LessThan2~6_combout\ & ( ((!\inst3|red~5_combout\) # ((!\inst2|pixel_column[7]~DUPLICATE_q\ & 
-- \inst3|LessThan0~0_combout\))) # (\inst3|LessThan3~6_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111101011111110100000000000000001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \inst2|ALT_INV_red_out~0_combout\,
...
PORT MAP (
	clk => \inst1|pll2_inst|altera_pll_i|outclk_wire[0]~CLKENA0_outclk\,
	asdata => \inst2|blue_out~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst2|blue_out~q\);
...
-- Equation(s):
-- \inst2|red_out~1_combout\ = ( \inst3|red~5_combout\ & ( !\inst3|LessThan3~6_combout\ & ( (!\inst3|LessThan2~6_combout\ & (\inst2|red_out~0_combout\ & ((!\inst3|LessThan0~0_combout\) # (\inst2|pixel_column[7]~DUPLICATE_q\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000010000000101000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_LessThan2~6_combout\,
	...
	datae => \inst3|ALT_INV_red~5_combout\,
